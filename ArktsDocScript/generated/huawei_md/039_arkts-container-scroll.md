# Scroll-滚动与滑动-ArkTS组件-ArkUI（方舟UI框架）-应用框架 - 华为HarmonyOS开发者
...
> - 手指触摸屏幕时，会停止当前触摸范围内所有滚动组件的滚动动画（[scrollTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollto)和[scrollToIndex](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolltoindex)接口触发的滚动动画除外），包括边缘回弹动画。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScrollDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolldirection枚举说明) | 是 | 滚动方向。 默认值：ScrollDirection.Vertical |

当滚动方向设置为[ScrollDirection.FREE](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolldirection枚举说明)时，Scroll组件仅支持部分能力，见[自由滚动模式下支持的能力](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolldirection枚举说明)。
...
设置滚动条的颜色。与[scrollBarColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollbarcolor)相比，color参数开始支持Resource类型。
...
限位动画期间[onWillScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onwillscroll12)事件上报的滚动操作来源类型为ScrollSource.FLING。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScrollSnapOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollsnapoptions10对象说明) | 是 | Scroll组件的限位滚动模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NestedScrollOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#nestedscrolloptions10对象说明) | 是 | 嵌套滚动选项。 默认值：{ scrollForward: NestedScrollMode.SELF_ONLY, scrollBackward: NestedScrollMode.SELF_ONLY } Scroll设置[enablePaging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#enablepaging11)或者[scrollSnap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollsnap10)，并同时设置父组件优先的嵌套滚动时，嵌套滚动不生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [OffsetOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#offsetoptions12对象说明) | 是 | 当输入的大小为百分比时，初始滚动偏移量为Scroll组件主轴方向大小与百分比数值之积。 |
...
| **支持的属性** | **支持的事件** | **支持的[Scroller](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scroller)接口** |
| --- | --- | --- |
| [scrollBar](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollbar) | [onWillScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onwillscroll12) | [scrollTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollto) |
| [scrollBarColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollbarcolor) | [onDidScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#ondidscroll12) | [scrollEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolledge) |
| [scrollBarWidth](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollbarwidth) | [onScrollEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrolledge) | [scrollPage](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollpage9) |
| [scrollBarMargin](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollbarmargin20) | [onScrollStart](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollstart9) | [currentOffset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#currentoffset) |
| [edgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#edgeeffect) | [onScrollStop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollstop9) | [scrollBy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollby9) |
| [enableScrollInteraction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#enablescrollinteraction10) | - | [getItemRect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#getitemrect11) |
| [friction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#friction10) | - | - |
| [clipContent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#clipcontent14) | - | - |
| [initialOffset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#initialoffset12) | - | - |
| [scrollable](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollable) | - | - |
...
支持[offsetRemain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollframebeginhandlerresult18对象说明)为负值。

若通过onScrollFrameBegin事件和[scrollBy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollby9)方法实现容器嵌套滚动，需设置子滚动节点的[EdgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#edgeeffect)为None。如Scroll嵌套List滚动时，List组件的[edgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#edgeeffect)属性需设置为EdgeEffect.None，否则抛滑List，会触发List的边缘回弹动画，导致嵌套滚动失效。
...
> **说明**
> 从API version 7开始支持，从API version 12开始废弃，建议使用[onWillScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onwillscroll12)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [ScrollOnWillScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollonwillscrollcallback12) | 是 | Scroll滚动前触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [ScrollOnScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollonscrollcallback12) | 是 | Scroll滚动时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnScrollEdgeCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrolledgecallback18) | 是 | 滚动到的边缘位置。 当Scroll设置为水平方向滚动时，上报[Edge.Center](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#edge)表示水平方向起始位置，上报[Edge.Baseline](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#edge)表示水平方向末尾位置。由于[Edge.Center](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#edge)和[Edge.Baseline](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#edge)枚举值已经废弃，推荐使用[onReachStart](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onreachstart11)、[onReachEnd](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onreachend11)事件监听是否滚动到边界。 |
...
> **说明**
> 从API version 7开始支持，从API version 9开始废弃，建议使用[onScrollStop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollstop9)替代。
...
滚动开始时触发。手指拖动Scroll或拖动Scroll的滚动条触发的滚动开始时，会触发该事件。使用[Scroller](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scroller)滚动控制器触发的带动画的滚动，动画开始时会触发该事件。
...
滚动停止时触发。手拖动Scroll或拖动Scroll的滚动条触发的滚动，手离开屏幕后滚动停止时会触发该事件。使用[Scroller](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scroller)滚动控制器触发的带动画的滚动，动画停止时会触发该事件。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [ScrollOnDidZoomCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollondidzoomcallback20) | 是 | 每帧缩放完成时回调。 |
...
> **说明**
> 若通过[onScrollFrameBegin](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollframebegin9)事件和[scrollBy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollby9)方法实现容器嵌套滚动，需设置子滚动节点的EdgeEffect为None。如Scroll嵌套List滚动时，List组件的[edgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#edgeeffect)属性需设置为EdgeEffect.None。
...
| 类型 | 说明 |
| --- | --- |
| void | [OffsetResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#offsetresult11对象说明) | 返回OffsetResult时按照开发者指定的偏移量滚动；不返回时按回调参数(xOffset, yOffset)滚动。 |
...
| 类型 | 说明 |
| --- | --- |
| [OnScrollFrameBeginHandlerResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollframebeginhandlerresult18对象说明) | 返回实际滑动量。 |

## OnScrollFrameBeginHandlerResult18+对象说明

[OnScrollFrameBeginCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollframebegincallback18)返回的实际相对上一帧滚动偏移量。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ScrollOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolloptions18对象说明) | 是 | 滑动到指定位置的参数。 |
...
| options12+ | [ScrollEdgeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolledgeoptions12对象说明) | 否 | 设置滚动到边缘位置的模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScrollPageOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollpageoptions14对象说明) | 是 | 设置翻页模式。 |
...
> **说明**
> 从API version 7开始支持，从API version 9开始废弃，建议使用[scrollPage9+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollpage9)替代。
...
Grid、List、WaterFlow组件有懒加载机制，组件内容没有加载并布局完成时，内容总偏移量通过估算得到，估算结果可能会有误差。其中List组件可以通过[childrenMainSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#childrenmainsize12)属性解决估算不准确的问题。
...
| 类型 | 说明 |
| --- | --- |
| [OffsetResult11+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#offsetresult11对象说明) | 返回当前的滚动总偏移量。 **说明：** 当scroller控制器未绑定容器组件或者容器组件被异常释放时，currentOffset的返回值为undefined。 |
...
| align | [ScrollAlign](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollalign10枚举说明) | 否 | 指定滑动到的元素与当前容器的对齐方式。 List中的默认值为：ScrollAlign.START。Grid中默认值为：ScrollAlign.AUTO。WaterFlow中的默认值为：ScrollAlign.START。 **说明：** 仅List、Grid、WaterFlow组件支持该参数。 |
| options12+ | [ScrollToIndexOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolltoindexoptions12对象说明) | 否 | 设置滑动到指定Index的选项，如额外偏移量。 默认值：0，单位：vp。 |
...
| canOverScroll | boolean | 否 | 是 | 设置滚动动画滚动到边界后，是否转换成越界回弹动画。 默认值：false **说明：** 仅在设置为true，且组件的edgeEffect设置为[EdgeEffect.Spring](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#edgeeffect)时，使用动画滚动到边界会转换为越界回弹动画，设置为false时，滚动到边界会直接停止动画，不会转换为越界回弹动画。 从API version 20开始，如果[ScrollOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrolloptions18对象说明)中的canOverScroll设置为true，表示滚动可以停留在过界位置，滚动动画过界后不会转换为回弹动画。 |
...
| animation10+ | [ScrollAnimationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollanimationoptions12对象说明) | boolean | 否 | 是 | 动画配置。 - ScrollAnimationOptions: 自定义滚动动效。 - boolean: 使能默认弹簧动效。 默认值： ScrollAnimationOptions: { duration: 1000, curve: Curve.Ease, canOverScroll: false } boolean: false **说明：** 当前List、Scroll、Grid、WaterFlow均支持boolean类型和ICurve曲线。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
设置[onWillScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onwillscroll12)事件的回调。
...
设置[onDidScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#ondidscroll12)事件的回调。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1c/v3/6sPEmbi0QnSkEpDDz7lGqg/zh-cn_image_0000002563127017.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=BBA6BE2F06D046F4152FDFC6544BA4424B53E11131CA9117AEF08F99760F4B99)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/TeSeGeA9SGaD6p-TUP6Dzw/zh-cn_image_0000002563207039.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=B951C4219F84E25C396063885B74088C0B6A49E7970105922959C9BD40E8FCF2)

### 示例3（嵌套滚动实现方式二）

该示例使用[nestedScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#nestedscroll10)属性实现了内层List组件和外层Scroll组件的嵌套滚动。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c6/v3/p2i2-ov3R8S-XRCrRpZvNg/zh-cn_image_0000002532087140.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=E763EC9670BDA549F6EC7EA40CA3F6EF1EA77ED7935F0AA17CE3BC97DF6427F5)

### 示例4（嵌套滚动父组件向子组件传递滚动）

该示例使用[enableScrollInteraction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#enablescrollinteraction10)属性和[onScrollFrameBegin](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#onscrollframebegin9)事件实现了父组件向子组件传递滚动。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/3gqh7-MXR62rzTQFSwQhkg/zh-cn_image_0000002532247076.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=1303B06B6C09D4E472FA5355740F27D74A4CD6433C5C685BD5D0DEDEF0030837)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/ZIe8DnnYStCn7QCFAC7XUg/zh-cn_image_0000002563127019.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=1194E6CB9E90D298709BC6E6EB593BC59A9EE3BF75E2506748DDAE90C0E3DDE4)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8a/v3/0xhppFt3SqKcllAWYa808Q/zh-cn_image_0000002563207041.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=D5E3D9759400EBFC5D52338F7CBA972F754344490A6C0C65E4CA3C7C87D73810)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/HPqTPqMWTNyTyTdPmV0Csg/zh-cn_image_0000002532087142.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=E633F1DEF8BADADB4B3356D055F0EADBB4EED73A8C333D4E8DDBF09FC5D8277F)

### 示例8（单边边缘效果）

该示例通过[edgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#edgeeffect)接口，实现了Scroll组件设置单边边缘效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d1/v3/odkOz19IREm800Zpudzy2A/zh-cn_image_0000002532247078.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=49BBC382BD42E7D5B2167FF5E8DC8231D5F82880BEBF36E3DF9128A2B18BF581)

### 示例9（划动翻页效果）

该示例通过[enablePaging](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#enablepaging11)接口，实现了Scroll组件滑动翻页效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/r8Jr7SrGSPeYRKksxAlZIQ/zh-cn_image_0000002563127021.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=323C2DFAF6465FBA2D53B187C246083954D982C2A4775B11A8A79165989647CE)

### 示例10（设置过界停留）

该示例通过[scrollTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollto)接口，实现了Scroll组件设置过界停留效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/FJmLXEKKReK3Ppev1JIwoA/zh-cn_image_0000002563207043.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=6740F35C2A3007B96B17DE924F7CD27753F4BDA7BFDAE704A1DA1B3B23748558)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/Fds3K-CmTRWdvckHgqVL1w/zh-cn_image_0000002532087144.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=51EA1AD58FCE3CD56C944255AB8690818EAF5944356A58358BEB442D2FC63077)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/jZmaYZewTWCnxRERUAzSqg/zh-cn_image_0000002532247080.gif?HW-CC-KV=V1&HW-CC-Date=20260327T024109Z&HW-CC-Expire=86400&HW-CC-Sign=DF5B4E6DB4B7E6260BF37239848CBE86FA94D5C955DD489318E766E59EC3CA06)

### 示例13（设置滚动事件）

该示例通过FrameNode中的[getEvent('Scroll')](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-framenode#geteventscroll19)获取[UIScrollEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#uiscrollevent19)，并为Scroll设置滚动事件回调，用于事件监听方因无法直接修改页面代码而无法使用声明式接口设置回调的场景。
