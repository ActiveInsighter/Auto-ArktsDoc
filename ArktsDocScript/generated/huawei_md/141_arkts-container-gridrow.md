...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| option | [GridRowOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#gridrowoptions对象说明) | 否 | 栅格布局子组件参数。 |
...
| gutter | [Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | [GutterOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#gutteroption) | 否 | 是 | 栅格布局间距。 默认值：0 非法值：按默认值处理。 单位：vp |
| breakpoints | [BreakPoints](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#breakpoints) | 否 | 是 | 设置断点值的断点数组以及基于应用窗口或容器尺寸的相应参照。 默认值： { value: ["320vp", "600vp", "840vp"], reference: BreakpointsReference.WindowSize } 非法值：按默认值处理。 单位：vp |
| direction | [GridRowDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#gridrowdirection枚举说明) | 否 | 是 | 栅格布局排列方向。 默认值：GridRowDirection.Row 非法值：按默认值处理。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| x | [Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | [GridRowSizeOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#gridrowsizeoption) | 否 | 是 | 栅格子组件水平方向间距。 |
| y | [Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | [GridRowSizeOption](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-gridrow#gridrowsizeoption) | 否 | 是 | 栅格子组件竖直方向间距。 |
...
> - 例：Item1: GridCol({ span: 6 })， Item2: GridCol({ span: 8, offset:11 })。 ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/22/v3/RuMmLGNeT6iqu_zZZCsk9Q/zh-cn_image_0000002542120506.png?HW-CC-KV=V1&HW-CC-Date=20260419T025917Z&HW-CC-Expire=86400&HW-CC-Sign=35FFF6AACD02970240A5A810BA3D90B181F78DE242A7FACC3D7013C1CEEF5C76)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a6/v3/ISXXfUXbT66ss15ruirLVQ/zh-cn_image_0000002572680777.png?HW-CC-KV=V1&HW-CC-Date=20260419T025917Z&HW-CC-Expire=86400&HW-CC-Sign=C8EE6B8BB5630B3910FE86E30B05604F77FE46CF8661D18A8DC47EAE504D8146)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/35/v3/xBzi1f6xQ4SFNImXKG8VXg/zh-cn_image_0000002541960870.png?HW-CC-KV=V1&HW-CC-Date=20260419T025917Z&HW-CC-Expire=86400&HW-CC-Sign=F3F0971661F262E3374FFB64AECFB84A1AA55F2BAF14A809E1806555137F5AA9)
