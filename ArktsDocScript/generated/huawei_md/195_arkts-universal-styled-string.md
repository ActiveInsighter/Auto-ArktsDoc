...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | string | [ImageAttachment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachment) | [CustomSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspan) | 是 | 属性字符串文本内容。 **说明：** 当value的类型为ImageAttachment或CustomSpan时，styles参数不生效。 需要设置styles时，通过[setStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#setstyle)等方法实现。 |
| styles | Array<[StyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styleoptions对象说明)> | 否 | 属性字符串初始化选项。 **说明：** start为异常值时，按默认值0处理； 当length为异常值时，length等于属性字符串在start后的实际长度； 当StyledStringKey与StyledStringValue不匹配时，styles不生效。 |
...
| 类型 | 说明 |
| --- | --- |
| string | 属性字符串文本内容。 **说明：** 当属性字符串中包含图片或[CustomSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspan)时，其返回的结果用空格表示。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| other | [StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstring) | 是 | StyledString类型的比较对象。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| boolean | 两个属性字符串是否相等。 true表示相等，false表示不相等。 **说明：** 当属性字符串的文本及样式均一致，视为相等。 不比较[GestureStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#gesturestyle)，当属性字符串配置了不同事件，文本和其他样式相同时，亦视为相等。 当比较[CustomSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspan)或[LeadingMarginSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#leadingmarginspan22)时，比较的是地址，地址相等，视为相等。 |
...
| 类型 | 说明 |
| --- | --- |
| [StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstring) | 子属性字符串。 **说明：** 当start为合法入参时，length的默认值是被查询属性字符串对象的长度与start的值的差。 当start和length越界或者必填传入undefined时，会抛出异常。 |
...
| styledKey | [StyledStringKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstringkey枚举说明) | 否 | 指定范围属性字符串样式的枚举值。 **说明：** 当不传入该参数时默认获取开发者设置的[StyledStringKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstringkey枚举说明)所有枚举值样式。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| Array<[SpanStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#spanstyle对象说明)> | 各样式对象的数组。 **说明：** 当指定范围属性字符串未设置任何样式，则返回空数组。 当start和length越界或者必填传入undefined时，会抛出异常； 当styledKey传入异常值或undefined时，会抛出异常。 当styledKey为CustomSpan时，返回的是创建CustomSpan时传入的样式对象，即修改该样式对象也会影响实际的显示效果。 |
...
使用方法参考[示例12（fromHtml和toHtml互相转换）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#示例12fromhtml和tohtml互相转换)。
...
| 类型 | 说明 |
| --- | --- |
| Promise<[StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstring)> | 属性字符串。 |
...
将属性字符串转换成HTML格式字符串。支持转换的属性字符串[StyledStringKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstringkey枚举说明)包括：StyledStringKey.FONT、StyledStringKey.DECORATION、StyledStringKey.LETTER_SPACING、StyledStringKey.TEXT_SHADOW、StyledStringKey.LINE_HEIGHT、StyledStringKey.IMAGE。
...
继承于[StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstring)类。
...
当属性字符串中包含图片或[CustomSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspan)时，同样生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spanStyle | [SpanStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#spanstyle对象说明) | 是 | 样式对象。 **说明：** 默认清空原有样式，替换为新样式。 当SpanStyle的styledKey为IMAGE或CUSTOM_SPAN时，只有当start的位置当前是image或CustomSpan且长度为1，才会生效，其余情况无效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| spanStyle | [SpanStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#spanstyle对象说明) | 是 | 样式对象。 默认不清空原有样式，叠加新样式。如果StyledStringValue类型相同，则新样式将覆盖旧样式。 当SpanStyle的styledKey为IMAGE或CUSTOM_SPAN时，只有当start的位置当前是image或CustomSpan且长度为1，才会生效，其余情况无效果。 |
...
| length | number | 是 | 指定范围的长度。 |
| styledKey | [StyledStringKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstringkey枚举说明) | 是 | 样式类型枚举值。 |
...
| start | number | 是 | 指定范围开始位置的下标。 |
| length | number | 是 | 指定范围的长度。 |
| other | [StyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstring) | 是 | 新的属性字符串对象。 |
...
| 类型 | 说明 |
| --- | --- |
| [TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle) | 文本字体样式。 |
| [DecorationStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#decorationstyle) | 文本装饰线样式。 |
| [BaselineOffsetStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#baselineoffsetstyle) | 文本基线偏移量样式。 |
| [LetterSpacingStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#letterspacingstyle) | 文本字符间距样式。 |
| [LineHeightStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#lineheightstyle) | 文本行高样式。 |
| [TextShadowStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textshadowstyle) | 文本阴影样式。 |
| [GestureStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#gesturestyle) | 事件手势样式。 |
| [ParagraphStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#paragraphstyle) | 文本段落样式。 |
| [ImageAttachment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachment) | 图片样式。 |
| [CustomSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspan) | 自定义绘制Span样式。 |
| [UserDataSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#userdataspan) | UserDataSpan样式。 |
| [UrlStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#urlstyle14) | 超链接样式。 |
| [BackgroundColorStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#backgroundcolorstyle14) | 文本背景颜色样式。 |
...
| styledKey | [StyledStringKey](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstringkey枚举说明) | 否 | 否 | 样式类型的枚举值。 |
| styledValue | [StyledStringValue](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styledstringvalue) | 否 | 否 | 样式对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TextStyleInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyleinterface对象说明) | 否 | 字体样式设置项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [GestureStyleInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#gesturestyleinterface对象说明) | 否 | 事件设置项。 |
...
| options20+ | [DecorationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#decorationoptions20) | 是 | 是 | 获取属性字符串的文本装饰线样式的额外配置选项。 **元服务API：** 从API version 20开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DecorationStyleInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#decorationstyleinterface) | 是 | 文本装饰线设置项。 默认值： { type: TextDecorationType.None, color: Color.Black, style: TextDecorationStyle.SOLID } |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DecorationStyleInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#decorationstyleinterface) | 是 | 文本装饰线设置项。 默认值： { type: TextDecorationType.None, color: Color.Black, style: TextDecorationStyle.SOLID, thicknessScale: 1.0 } |
| options | [DecorationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#decorationoptions20) | 否 | 文本装饰线额外配置选项。 默认值： { enableMultiType: undefined } |
...
| layoutStyle | [ImageAttachmentLayoutStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentlayoutstyle对象说明) | 是 | 是 | 获取属性字符串的图片布局。 **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| colorFilter15+ | [ColorFilterType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#colorfiltertype15) | 是 | 是 | 获取属性字符串的图片颜色滤镜效果。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ImageAttachmentInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentinterface对象说明) | 是 | 图片设置项。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| attachment | Optional<[AttachmentType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#attachmenttype15)> | 是 | PixelMap类型或[ResourceStr](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcestr)类型图片设置项。 |
...
| 类型 | 说明 |
| --- | --- |
| [ImageAttachmentInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentinterface对象说明) | PixelMap类型图片设置项。 |
| [ResourceImageAttachmentOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#resourceimageattachmentoptions15) | ResourceStr类型图片设置项。 |
...
| layoutStyle | [ImageAttachmentLayoutStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentlayoutstyle对象说明) | 否 | 是 | 设置图片布局。 **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
| colorFilter15+ | [ColorFilterType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#colorfiltertype15) | 否 | 是 | 设置属性字符串的图片颜色滤镜效果。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
...
| layoutStyle | [ImageAttachmentLayoutStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentlayoutstyle对象说明) | 否 | 是 | 设置图片布局。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
| colorFilter | [ColorFilterType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#colorfiltertype15) | 否 | 是 | 设置属性字符串的图片颜色滤镜效果。 **元服务API：** 从API version 15开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| measureInfo | [CustomSpanMeasureInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspanmeasureinfo对象说明) | 是 | 文本的字体大小。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [CustomSpanMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspanmetrics对象说明) | 自定义绘制Span的尺寸信息。 **说明：** 最终的CustomSpan的高度是由当前Text组件的行高所决定的。当height不传值，则默认取Text组件的fontSize的值作为CustomSpan的高度；当height大于当前行的其他子组件的高度时，此时height即为Text组件的行高。 |
...
| drawInfo | [CustomSpanDrawInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspandrawinfo对象说明) | 是 | 自定义绘制Span的绘制信息。 |
...
| leadingMarginSpan22+ | [LeadingMarginSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#leadingmarginspan22) | 是 | 是 | 获取属性字符串文本段落的自定义缩进信息。 **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ParagraphStyleInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#paragraphstyleinterface对象说明) | 否 | 段落样式设置项。 |
...
| leadingMarginSpan22+ | [LeadingMarginSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#leadingmarginspan22) | 否 | 是 | 设置文本段落的自定义缩进。不支持百分比。 默认值：0 **元服务API：** 从API version 22开始，该接口支持在元服务中使用。 |
...
| drawInfo | [LeadingMarginSpanDrawInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#leadingmarginspandrawinfo22对象说明) | 是 | 自定义绘制信息。 |
...
从API version 12开始，该示例通过[insertString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#insertstring)、[removeStyles](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#removestyles)、[replaceStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#replacestyle)、[getStyles](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#getstyles)接口实现属性字符串的插入、删除、替换、查看。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/3S72hZzNTNG0A3Xg1DXuZg/zh-cn_image_0000002541961068.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=9AD520455D631342DE8C61B27791C368BA768BA7E47DFC887A8ADC0B2431755F)

### 示例2（设置事件）

从API version 12开始，该示例通过[StyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#styleoptions对象说明)中的styledKey、styledValue接口实现属性字符串绑定事件。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b5/v3/9LnZpO5DS9uYP6iYPzvf3A/zh-cn_image_0000002572641013.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=3BC33B937343CD93CF5E9BAF29C3521599CD64DB14E5EFB1F84C4A0DFEAF11FD)

### 示例3（设置文本样式）

从API version 12开始，该示例通过[getStyles](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#getstyles)、[setStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#setstyle)接口实现属性字符串查询和设置样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/7-v-YYhoTJmp7Sbs2YvypQ/zh-cn_image_0000002542120706.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=A8DDD6B5CBE6AF40E220A492767F14EB1EF38D4737B5BDA3D8F44ED6DC078BC4)

### 示例4（设置图片）

从API version 12开始，该示例通过[ImageAttachment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentinterface对象说明)接口实现属性字符串设置图片。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/ABaiFGC2SJO0ngKIwPcnYw/zh-cn_image_0000002572680977.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=EFF4D6842E8D29DE4F2377D8F5E208004183465945861F7F3EA41F6FFE9EE240)

### 示例5（设置文本行高和段落样式）

从API version 12开始，该示例通过[LineHeightStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#lineheightstyle)、[ParagraphStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#paragraphstyle)接口实现属性字符串设置文本行高和段落样式。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bc/v3/KfJWGRzZSoqLOTndy1adUQ/zh-cn_image_0000002541961070.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=2BA71ADE2348CA5C4345CB25288509FA581586D10EF9FFE6351480D7F2971BFC)

### 示例6（设置自定义绘制Span）

从API version 12开始，该示例通过[CustomSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#customspan)接口和[measureTextSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-uicontext-measureutils#measuretextsize12)实现属性字符串设置自定义绘制Span。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3c/v3/WBvFMBMnQh2l-c7XJ0EGFA/zh-cn_image_0000002572641015.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=495BBD5AED762BF59723BFD7A49470E4C5FB023B90E4E73BB63AE8A79CA56CCE)

### 示例7（支持存储自定义扩展信息）

从API version 12开始，该示例通过[UserDataSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#userdataspan)接口实现属性字符串支持存储自定义扩展信息的功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/megSx2mMSqSWai9UuHtfBw/zh-cn_image_0000002542120708.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=53782C9F69B08219E546AA71DB23C3A2A7FFC83C476642E223520FDDE0C181FA)

### 示例8（设置超链接）

从API version 14开始，该示例通过[UrlStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#urlstyle14)接口，实现了对属性字符串中超链接设置的支持。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2c/v3/ouLajHI1QXuO1qhzrWKgjA/zh-cn_image_0000002572680979.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=8911AB5FCCBA4F08396AAF02B1B80D12CE5EC17D9D8F6BE57DA117A9CE4D2C9A)

### 示例9 （给图片设置colorFilter）

从API version 15开始，该示例通过给[ImageAttachment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentinterface对象说明)设置colorFilter实现了给图像设置颜色滤镜效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/51/v3/aQinroqqRoGHKaQoAFfVyQ/zh-cn_image_0000002541961072.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=5420AF64C304F8CF3F8201B9EAB8F7A3BA1BB4EB0474AA1C8A3649FD90BCEEFC)

### 示例10（属性字符串的插入、删除、替换）

从API version 12开始，该示例通过[subStyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#substyledstring)、[removeString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#removestring)、[removeStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#removestyle)、[clearStyles](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#clearstyles)、[replaceStyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#replacestyledstring)、[insertStyledString](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#insertstyledstring)接口实现属性字符串的插入、删除、替换。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/RukwiM9PRWiGx2JbUm1hsw/zh-cn_image_0000002572641017.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=8B261B8F3545E21ACC0EE4407667D5E23202FC178FA0A4402586A0EA5B4669CF)

### 示例11（属性字符串的文本描边）

从API version 20开始，该示例通过[TextStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#textstyle)设置strokeWidth和strokeColor接口实现属性字符串的文本描边。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d8/v3/ldqh1SUoTYWorZ_alqqihQ/zh-cn_image_0000002542120710.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=A7E5FB141DD432F2BEFFABEBA24152BF8BF36D12DA7F0B9D05943273B9605CFB)

### 示例12（fromHtml和toHtml互相转换）

该示例通过[fromHtml](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#fromhtml)（从API version 12开始）、[toHtml](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#tohtml14)（从API version 14开始）接口，将HTML中strong、b20+、em20+、i20+、u20+、del20+、s20+、a20+、sub20+、sup20+标签及其style属性中的background-color转换为属性字符串并转回HTML。
  ...
  build() {
    Column() {
      ...
      Button("重置").onClick(() => {
        ...
        this.controller.setStyledString(new StyledString(""));
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7c/v3/g9UVZNtcRPeIX0tZK9_uUw/zh-cn_image_0000002572680981.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=54BF14B71FD41F7AE9D2CBA3D4DD1758A900B3263F33299B3D3A9EF74F58AC4B)

### 示例13（多装饰线与加粗装饰线）

从API version 20开始，该示例通过[DecorationStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#decorationstyle)中设置enableMultiType、thicknessScale接口，实现多装饰线显示与加粗装饰线的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e1/v3/IZ2_l45XSsOnSXJxs-qDNg/zh-cn_image_0000002541961074.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=54567A6C2448B64B59D49D87E4E4AB99C2E850771BA3F3EE76B72F587CA72E70)

### 示例14（获取以vp为单位的图片尺寸）

从API version 21开始，该示例通过[ImageAttachmentInterface](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#imageattachmentinterface对象说明)实现属性字符串设置图片，并且获取该图片以vp为单位的尺寸。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/71/v3/M6RQ-mfTT6Cklv5_aQkhqA/zh-cn_image_0000002572641019.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=6ABA214B8593BFCD223D30E8BF685FA24BDAD2B9F6FD0663589E21538AD40184)

### 示例15（设置段落自定义缩进）

从API version 22开始，该示例通过[LeadingMarginSpan](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#leadingmarginspan22)设置段落缩进，并且自定义缩进图案。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/4vleMGofQdChHK5-FAUMjQ/zh-cn_image_0000002542120712.gif?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=B456076FF4B77258C871E452C7B29AEC8195DBC2243E71365D1374EF60431DC7)

### 示例16（使用supportSvg2属性时，SVG图片的显示效果）

从API version 22开始，该示例通过给[ResourceImageAttachmentOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-styled-string#resourceimageattachmentoptions15)设置supportSvg2属性，使[SVG标签解析能力增强功能](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-image-svg2-capabilities#svg易用性提升)的SVG易用性提升能力生效。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c4/v3/B3MTeOb5SSybu41zkpg-dw/zh-cn_image_0000002572641007.png?HW-CC-KV=V1&HW-CC-Date=20260419T030029Z&HW-CC-Expire=86400&HW-CC-Sign=8227C1A201EA02B51042EDFEAF1ED3FF1B2F1562797C6606475D4EE4855B344A)
