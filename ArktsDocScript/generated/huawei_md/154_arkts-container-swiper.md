...
> - Swiper组件通过内置的[PanGesture](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-gestures-pangesture)拖动手势实现滑动轮播效果，将[disableSwipe](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#disableswipe8)属性设为true时，会禁用该手势监听，从而阻止滑动操作。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [SwiperController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontroller) | 否 | 给组件绑定一个控制器，用来控制组件翻页或者预加载指定子节点。 |
...
[loop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#loop)为false时，自动轮播到最后一页时停止轮播。手势切换后不是最后一页时继续播放。当Swiper不可见时会停止轮播。
...
当[loop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#loop)设置为false时，自动轮播将在到达最后一页时停止。在通过手势切换且未处于最后一页的情况下，轮播将继续进行。Swiper在不可见时，轮播也将停止。
...
| options | [AutoPlayOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#autoplayoptions18对象说明) | 是 | 配置手指或者鼠标等按下屏幕时子组件是否停止自动播放。当stopWhenTouched设置为true时，多指按下场景中任意一个手指抬起后，将自动继续播放。 默认值：{ stopWhenTouched: true }，停止自动播放。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DotIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#dotindicator10)10+ | [DigitIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#digitindicator10)10+ | boolean | 是 | 可选导航点指示器样式。 - DotIndicator：圆点指示器样式。 - DigitIndicator：数字指示器样式。 - boolean：是否启用导航点指示器。设置为true启用，false不启用。 默认值：true 默认类型：DotIndicator |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| indicator | [IndicatorComponentController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-swiper-components-indicator#indicatorcomponentcontroller)15+ | [DotIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#dotindicator10) | [DigitIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#digitindicator10) | boolean | 是 | 可选导航点指示器样式。 - IndicatorComponentController：单独导航点指示器控制器。当使用单独导航点指示器控制器时，可以与外部单独导航点进行绑定，但是绑定的单独导航点和内置导航点不能同时存在。 - DotIndicator：圆点指示器样式。 - DigitIndicator：数字指示器样式。 - boolean：是否启用导航点指示器。设置为true启用，false不启用。 默认值：true 默认类型：DotIndicator。 |

### nestedScroll11+

nestedScroll(value: SwiperNestedScrollMode)

设置Swiper组件和父组件的嵌套滚动模式。[loop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#loop)为true时Swiper组件没有边缘，不会触发父组件嵌套滚动。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SwiperNestedScrollMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipernestedscrollmode11枚举说明) | 是 | Swiper组件和父组件的嵌套滚动模式。 传入非法值时，按SwiperNestedScrollMode.SELF_ONLY处理。 |
...
设置边缘滑动效果，[loop](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#loop)为false或Swiper视窗内一屏显示所有子节点时生效。调用[SwiperController.changeIndex()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#changeindex12)、[SwiperController.showNext()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#shownext)和[SwiperController.showPrevious()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#showprevious)接口跳转至首尾页时不生效回弹。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | 是 | 自动播放时播放的时间间隔。当该值小于[duration](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#duration)属性值时，翻页完成后会立即开始下一次轮播。 默认值：3000 单位：毫秒 取值范围：[0, +∞)，设置小于0的值时，按照默认值处理。 |
...
duration需要和[curve](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#curve8)一起使用。
...
使用string类型时，根据子元素的主轴宽度线性布局，不再适应Swiper主轴宽度。此时value值仅支持设置为'auto'，设置[customContentTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#customcontenttransition12)和[onContentDidScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#oncontentdidscroll12)事件不生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [SwiperAutoFill](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperautofill10)10+ | 是 | 视窗内显示的子元素个数。 默认值：1 取值范围：(0, +∞)，设置小于等于0的值时，按照默认值处理。 |
...
参数说明参考[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | number | string | [SwiperAutoFill](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperautofill10) | [ItemFillPolicy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#itemfillpolicy22) | 是 | 视窗内显示的子元素个数。 取值范围：(0, +∞)，设置小于等于0的值时，按照1处理。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ArrowStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#arrowstyle10对象说明) | boolean | 是 | 支持设置箭头和底板样式，异常场景使用ArrowStyle对象中的默认值。设置为false不显示箭头和底板，true显示默认的箭头和底板样式。 默认值：false |
...
设置主轴方向上元素排列的模式，优先以[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)设置的个数显示，displayCount未设置时本属性生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SwiperDisplayMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperdisplaymode枚举说明) | 是 | 主轴方向上元素排列的模式。 默认值：SwiperDisplayMode.STRETCH |

### nextMargin10+

nextMargin(value: Length, ignoreBlank?:boolean)

设置后边距，用于露出后一项的一小部分，使用效果可以参考[示例1设置导航点交互及翻页动效](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#示例1设置导航点交互及翻页动效)。仅当Swiper子组件的布局方式为拉伸时生效，主要包括两种场景：1、displayMode属性设置为SwiperDisplayMode.STRETCH；2、displayCount属性设置为number类型。
...
设置前边距，用于露出前一项的一小部分，使用效果可以参考[示例1设置导航点交互及翻页动效](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#示例1设置导航点交互及翻页动效)。仅当Swiper子组件的布局方式为拉伸时生效，主要包括两种场景：1、displayMode属性设置为SwiperDisplayMode.STRETCH；2、displayCount属性设置为number类型。
...
在[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)属性的swipeByGroup参数设置为true，即按组翻页生效时，一次在显示区域上方或前方插入或删除数据，且插入或删除的是一组节点数量倍数的数据量时，才能保持可见内容位置不变，否则可见内容位置可能会随每组数据重新分组改变。
...
> **说明**
> 从API version 8开始支持，从API version 10开始废弃，建议使用[indicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#indicator)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [IndicatorStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#indicatorstyledeprecated对象说明) | 否 | 导航点样式。 |
...
| AutoLinear(deprecated) | 1 | Swiper滑动一页的宽度为子组件宽度中的最大值。此枚举表现形式与[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)中使用string类型，将值设置为auto表现一致，具体可参考[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)说明。 **说明**：从API version 7开始支持，从API version 10开始废弃，建议使用AUTO_LINEAR替代。 **卡片能力：** 从API version 7开始，该接口支持在ArkTS卡片中使用。 |
| STRETCH10+ | 0 | Swiper滑动一页的宽度为Swiper组件自身的宽度。 **卡片能力：** 从API version 10开始，该接口支持在ArkTS卡片中使用。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| AUTO_LINEAR(deprecated) | 1 | Swiper滑动一页的宽度为视窗内最左侧子组件的宽度。此枚举表现形式与[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)中使用string类型，将值设置为auto表现一致，具体可参考[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)说明。 **说明**：从API version 10开始支持，从API version 12开始废弃，建议使用[Scroller.scrollTo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll#scrollto)替代。 **卡片能力：** 从API version 10开始，该接口支持在ArkTS卡片中使用。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
翻至下一页。翻页带动效切换过程，时长通过Swiper的[duration](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#duration)属性设置。
...
翻至上一页。翻页带动效切换过程，时长通过Swiper的[duration](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#duration)属性设置。
...
| --- | --- | --- | --- |
| index | number | 是 | 指定页面在Swiper中的索引值。 **说明：** 设置的值小于0或大于最大页面索引时，取0。 |
| animationMode | [SwiperAnimationMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperanimationmode15枚举说明) | boolean | 否 | 设置翻页至指定页面时的动效模式。 默认值：SwiperAnimationMode.NO_ANIMATION **说明：** 当传入true时有动效，等同于SwiperAnimationMode.DEFAULT_ANIMATION；当传入false时无动效，等同于SwiperAnimationMode.NO_ANIMATION。 |
...
| ignoreSize | boolean | 是 | 设置是否忽略导航点本身大小，默认false。 设为true时可以将导航点更靠近Swiper底部，使用方法可以参考[示例9演示导航点space与bottom](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#示例9演示导航点space与bottom)。 说明：[数字导航点](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#digitindicator10)ignoreSize属性，不生效的场景如下： • 当[vertical](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#vertical) 设置为false，且bottom > 0。 • 当[vertical](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#vertical) 设置为true时： 1、bottom > 0 时。 2、bottom设为undefined。 3、isSidebarMiddle设置为false时。 |
...
| 类型 | 说明 |
| --- | --- |
| [DotIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#dotindicator10) | 圆点指示器。 |
...
| 类型 | 说明 |
| --- | --- |
| [DigitIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#digitindicator10) | 数字指示器。 |

## DotIndicator10+

构造圆点指示器的样式，继承自[Indicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#indicator10)。
...
| 类型 | 说明 |
| --- | --- |
| [DotIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#dotindicator10) | 返回当前圆点指示器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| maxDisplayCount | number | 是 | 设置圆点导航点指示器样式下，导航点显示个数最大值，当实际导航点个数大于最大导航点个数时，会生效超长效果样式，样式如[示例5](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#示例5设置圆点导航点超长显示)所示。 默认值：这个属性没有默认值，如果设置异常值那等同于没有超长显示效果。 取值范围：[6, 9] **说明：** 1、超长显示场景，目前暂时不支持交互功能（包括：手指点击拖拽、鼠标操作等）。 2、在超长显示场景下，中间页面对应的选中导航点的位置，并不是完全固定的，取决于之前的翻页操作序列。 3、当前仅支持displayCount为1的场景。 |
...
构造数字指示器的样式，继承自[Indicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#indicator10)。
...
| 类型 | 说明 |
| --- | --- |
| [DigitIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#digitindicator10) | 返回当前数字指示器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnSwiperAnimationStartCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onswiperanimationstartcallback18) | 是 | 切换动画开始时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnSwiperAnimationEndCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onswiperanimationendcallback18) | 是 | 切换动画结束时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event | [OnSwiperGestureSwipeCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onswipergestureswipecallback18) | 是 | 在页面跟手滑动过程中，逐帧触发的回调。onGestureSwipe回调触发时机在onTouch之后，如果需要在离手后执行操作建议使用[onAnimationStart](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onanimationstart9)。 |
...
2、在页面跟手滑动和离手后执行切换动画的过程中，会对视窗内所有页面逐帧触发[SwiperContentTransitionProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontenttransitionproxy12)回调。例如，当视窗内有下标为0、1的两个页面时，会每帧触发两次index值分别为0和1的回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transition | [SwiperContentAnimatedTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontentanimatedtransition12) | 是 | Swiper自定义切换动画相关信息。 |
...
2、在页面滑动过程中，会对视窗内所有页面逐帧触发[ContentDidScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#contentdidscrollcallback12)回调。例如，当视窗内有下标为0、1的两个页面时，会每帧触发两次index值分别为0和1的回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [ContentDidScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#contentdidscrollcallback12) | 是 | Swiper滑动时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [ContentWillScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#contentwillscrollcallback15) | 是 | Swiper滑动时触发的回调。 |
...
| extraInfo10+ | [SwiperAnimationEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperanimationevent10对象说明) | 是 | 动画相关信息，包括主轴方向上当前显示元素和目标元素相对Swiper起始位置的位移，以及离手速度。 |
...
| --- | --- | --- | --- |
| index | number | 是 | 当前显示元素的索引。多列Swiper时，index为最左侧组件的索引。 |
| extraInfo10+ | [SwiperAnimationEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperanimationevent10对象说明) | 是 | 动画相关信息，只返回主轴方向上当前显示元素相对于Swiper起始位置的位移。 |
...
| --- | --- | --- | --- |
| index | number | 是 | 当前显示元素的索引。多列Swiper时，index为最左侧组件的索引。 |
| extraInfo | [SwiperAnimationEvent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperanimationevent10对象说明) | 是 | 动画相关信息，只返回主轴方向上当前显示元素相对于Swiper起始位置的位移。 |
...
Swiper滑动时触发的回调，参数可参考[SwiperContentTransitionProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontenttransitionproxy12)中的说明。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| result | [SwiperContentWillScrollResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontentwillscrollresult15对象说明) | 是 | 即将滑动的相关信息，主要包括：当前页面对应的index、滑动方向上即将显示的页面index和此次滑动的位移。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| timeout | number | 否 | 是 | Swiper自定义切换动画超时时间。从页面执行默认动画（页面滑动）至移出视窗外的第一帧开始计时，如果到达该时间后，开发者仍未调用[SwiperContentTransitionProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontenttransitionproxy12)的finishTransition接口通知Swiper组件此页面的自定义动画已结束，那么组件就会认为此页面的自定义动画已结束，立即将该页面节点下渲染树。单位ms，默认值为0。 |
| transition | Callback<[SwiperContentTransitionProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swipercontenttransitionproxy12)> | 否 | 否 | 自定义切换动画具体内容。 |
...
> **说明**
> 从API version 8开始支持，从API version 10开始废弃，建议使用[indicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#indicator10)替代。
...
该示例通过[changeIndex](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#changeindex15)接口设置[SwiperAnimationMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#swiperanimationmode15枚举说明)动效以跳转指定页面，并使用[onScrollStateChanged](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onscrollstatechanged20)回调监听滑动状态的变化。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8e/v3/YFUAwuLURiW4V11tV0axLw/zh-cn_image_0000002541960906.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=B6AB94B171312646FA2FF26CB50C4019F4598C0C2AE8B3AD03704A3A13892534)

### 示例2（设置数字指示器）

该示例通过[DigitIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#digitindicator10)接口，实现了数字指示器的效果和功能。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ec/v3/sYZjtXOGRROgZwXCsXlAWw/zh-cn_image_0000002572640851.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=97C8BA4CF1C3A832C40E54C329D1D17CEA8B9C427C1DC94573E64056B74488C5)

### 示例3（设置按组翻页）

该示例通过[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount8)属性实现了按组翻页效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/DN58h0afSZiWGUl2G50BlA/zh-cn_image_0000002542120544.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=88F7C417C51CD66D53688DC478A90DB53E4A938B778DA679F7BC9A41584977A7)

### 示例4（设置自定义页面切换动画）

该示例通过[customContentTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#customcontenttransition12)接口，实现了自定义Swiper页面按组翻页动画效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/i3PRMaGwQaWffFf70swzoA/zh-cn_image_0000002572680815.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=FEE5CA716BC4F885070D5210CC302294E7E1A5A2A6A33A821319DFD570218F2D)

### 示例5（设置圆点导航点超长显示）

该示例通过DotIndicator接口的[maxDisplayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#maxdisplaycount12)属性，实现了圆点导航点超长显示动画效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a4/v3/rRtbb8HXQCi3kigAwtZTrw/zh-cn_image_0000002541960908.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=C104ED6F9087FF3286939917D705C0F8CC8D5B2256183EE94283A141D05A1537)

### 示例6（预加载子节点）

该示例通过[preloadItems](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#preloaditems18)接口实现了预加载指定子节点。
...
该示例通过[onSelected](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#onselected18)接口，实现了[Tabs](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-tabs)与Swiper联动切换。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/gHqytWQ4QyK2Jp2YOfKWJg/zh-cn_image_0000002572640853.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=C34B3406ACF89B6904D83CB04E5DD4872BB601C4EECCB8AA1ADCA1285BC1A3A6)

### 示例8（滑动行为拦截事件）

该示例通过[onContentWillScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#oncontentwillscroll15)事件实现了单方向的滑动翻页，即只能滑动向前翻页，滑动向后翻页的行为会被拦截。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6c/v3/CDlglsxES4qpQ0YYZRnXLg/zh-cn_image_0000002542120546.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=EDC6D56E501E178301DBFF6462319AF898D0EC87DFB5AF6114580774D808C1A8)

### 示例9（演示导航点space与bottom）

该示例通过[bottom](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#bottom19)和[space](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#space19)接口，实现了圆点导航点与底部间距为0的间距控制以及导航点之间的间距控制。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/xoQ8CqYcSMObT77ulFGyjA/zh-cn_image_0000002572680817.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=5398C8C8D2DC19D4509B39FEC31631CAB30796A0A961FC279C505CD8730CB5E3)

### 示例10（Swiper组件基于断点配置显示个数）

该示例展示了Swiper组件基于断点配置显示个数的效果。

从API version 22开始，新增[displayCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-swiper#displaycount22)接口，用于设置Swiper视窗内元素显示个数。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/54/v3/J_hFsnXZRP6WdH1vHA46pQ/zh-cn_image_0000002541960910.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=D562F033F473CCCF89E8CF60A7520CCE28DF171E94F8B3C8F9FB6A6AD19BC54F)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f6/v3/Gt9ut5DURSW2g16tzkuyoQ/zh-cn_image_0000002572640855.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024327Z&HW-CC-Expire=86400&HW-CC-Sign=008431A53616D962837D6B74456EE88B9443AD09D90B71837C10D3800AD7E705)
