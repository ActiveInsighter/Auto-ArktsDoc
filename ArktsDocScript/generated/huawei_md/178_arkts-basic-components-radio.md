...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [RadioOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-radio#radiooptions对象说明) | 是 | 配置单选框的参数。 |
...
| indicatorType12+ | [RadioIndicatorType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-radio#radioindicatortype12枚举说明) | 否 | 是 | 配置单选框的选中样式。未设置时按照RadioIndicatorType.TICK进行显示。 **卡片能力：** 从API version 12开始，该接口支持在ArkTS卡片中使用。 **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
设置单选框的选中状态。与[checked](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-radio#checked)相比，isChecked参数新增了对undefined类型的支持。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[OnRadioChangeCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-radio#onradiochangecallback18)> | 是 | 单选框选中状态改变时触发该回调。 当callback的值为undefined时，不使用回调函数。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/ta3znf2XQmWpQMZvlH3EfA/zh-cn_image_0000002541960984.gif?HW-CC-KV=V1&HW-CC-Date=20260420T025944Z&HW-CC-Expire=86400&HW-CC-Sign=237836B73089516D6E593DC2FE8DBDA281856D9CC2442DC7970118A7B0D1A2EC)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/bZaxzmdBSj-Hdi5_gI7_lA/zh-cn_image_0000002572640929.gif?HW-CC-KV=V1&HW-CC-Date=20260420T025944Z&HW-CC-Expire=86400&HW-CC-Sign=6B87B8AEB92E886A91B3BF59BA37D8405362FDCAF21C298339F3EF4399FEC263)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/3PEFrW4aSUOL0GDDzhsjWw/zh-cn_image_0000002542120622.gif?HW-CC-KV=V1&HW-CC-Date=20260420T025944Z&HW-CC-Expire=86400&HW-CC-Sign=DCA2B9A10F2AC4532E098FE4A99F2AE40CC342DFEF766355BB675374ADAFC0B9)
