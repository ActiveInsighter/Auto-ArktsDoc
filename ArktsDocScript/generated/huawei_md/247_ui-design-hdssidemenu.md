...
| 参数名 | 类型 | 必填 | 装饰器类型 | 说明 |
| --- | --- | --- | --- | --- |
| items | [HdsSideMenuMainItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section1050510599502)[] | 否 | @Param | 一级菜单栏组，数量最多为5个。 |
| selectedIndex | number | 是 | @Param @Require | 当前选中的菜单栏。 取值范围：大于等于-1的整数。 -1表示当前侧边菜单栏没有菜单被选中。 |
| $selectedIndex | [OnSelectedIndexChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section58771018173714) | 否 | @Event | 用于双向绑定selectedIndex。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [HdsSideMenuMainItemParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section292095817402) | 是 | HdsSideMenu一级菜单栏的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [HdsSideMenuSubItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section144191823155313)[] | 当前菜单下的二级菜单对象数组。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| badge | [HdsSideMenuBadgeParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section10384044394) | 否 | HdsSideMenu上带信息提醒的图标配置信息。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [HdsSideMenuMainItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section1050510599502) | 当前菜单下的一级菜单对象。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| param | [HdsSideMenuSubItemParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section730054414319) | 是 | HdsSideMenu二级菜单栏的参数。 |
...
| 类型 | 说明 |
| --- | --- |
| [HdsSideMenuSubItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section144191823155313) | 当前菜单下的二级菜单对象。 |
...
HdsSideMenu一级菜单栏配置项，继承自[HdsSideMenuBaseItemParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section131215146362)。
...
| hdsSideMenuSubItem | [HdsSideMenuSubItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section144191823155313)[] | 否 | 是 | 设置一级菜单栏中的二级菜单栏数组。二级菜单栏数量最多5个。 |
| badge | [HdsSideMenuBadgeParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section10384044394) | 否 | 是 | 设置一级菜单栏上带信息提醒的图标配置信息。 |

## HdsSideMenuSubItemParam

HdsSideMenu二级菜单栏配置项，继承自[HdsSideMenuBaseItemParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section131215146362)。
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| badge | [HdsSideMenuBadgeParam](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssidemenu#section10384044394) | 否 | 是 | 设置二级菜单栏上带信息提醒的图标配置信息。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ff/v3/byMK5k8vT7Sv2HqM_yvszA/zh-cn_image_0000002500424072.png?HW-CC-KV=V1&HW-CC-Date=20260407T024605Z&HW-CC-Expire=86400&HW-CC-Sign=685F14CE258DFEE1A689F0B5538C0B1D4E15263CCF0C12833BD42C11DA32A64A)
