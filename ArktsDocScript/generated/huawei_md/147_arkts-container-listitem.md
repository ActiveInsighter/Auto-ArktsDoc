...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ListItemOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#listitemoptions10对象说明) | 否 | 为ListItem提供可选参数，该对象内含有[ListItemStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#listitemstyle10枚举说明)枚举类型的style参数。 默认值：{ style: ListItemStyle.NONE } |
...
> **说明**
> 从API version 7开始支持，从API version 10开始废弃，建议使用[ListItem10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#listitem10)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Sticky](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#stickydeprecated枚举说明) | 是 | ListItem吸顶效果。 默认值：Sticky.None |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | [EditMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#editmodedeprecated枚举说明) | 是 | ListItem元素是否可编辑。 默认值：false |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [SwipeActionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeactionoptions9对象说明) | 是 | ListItem的划出组件。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| start | [CustomBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#custombuilder8) | [SwipeActionItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeactionitem10对象说明) | 否 | 是 | ListItem向右划动时item左边的组件（List垂直布局时）或ListItem向下划动时item上方的组件（List水平布局时）。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| end | [CustomBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#custombuilder8) | [SwipeActionItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeactionitem10对象说明) | 否 | 是 | ListItem向左划动时item右边的组件（List垂直布局时）或ListItem向上划动时item下方的组件（List水平布局时）。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
| edgeEffect | [SwipeEdgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeedgeeffect9枚举说明) | 否 | 是 | 滑动效果。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| onStateChange11+ | (state:[SwipeActionState](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeactionstate11枚举说明)) => void | 否 | 是 | 当列表项滑动状态变化时候触发。 **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| direction | [ListItemSwipeActionDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#listitemswipeactiondirection21枚举说明) | 是 | ListItem划出菜单的展开方向。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/be/v3/RKHcD1A0TQmTLfT5wtr8UA/zh-cn_image_0000002538129710.gif?HW-CC-KV=V1&HW-CC-Date=20260413T025917Z&HW-CC-Expire=86400&HW-CC-Sign=4D1598F6F0744899CA0190712FC2A3EED9597E09791D92AD48E58A67CAE79C5A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a5/v3/SmulLX3MTuy3Q9Uq9uLUGQ/zh-cn_image_0000002538289644.gif?HW-CC-KV=V1&HW-CC-Date=20260413T025917Z&HW-CC-Expire=86400&HW-CC-Sign=01A2D9B225FCB6254C0DCB4DE2E8802ACCC62EB5B1787A322FFC34029F0CB2BE)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e9/v3/4KPDFHNWTIW8qq826MSM5g/zh-cn_image_0000002569169407.jpeg?HW-CC-KV=V1&HW-CC-Date=20260413T025917Z&HW-CC-Expire=86400&HW-CC-Sign=5FFD2457BCEA8424BFEDC36AE45475D16CED6C50A37482E4E07F2AE92174D8BF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/5v1IzdoBR8SegClpjFvnIg/zh-cn_image_0000002569129433.gif?HW-CC-KV=V1&HW-CC-Date=20260413T025917Z&HW-CC-Expire=86400&HW-CC-Sign=53FFFFCEE638B23209C08B6545DCB377CDBA0FEC942528AE84A5F37F910BDE4B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/qtoDWb3LTKqkuCMvTgng9A/zh-cn_image_0000002538129712.gif?HW-CC-KV=V1&HW-CC-Date=20260413T025917Z&HW-CC-Expire=86400&HW-CC-Sign=860C58E5E72011B06425336FD9594F62749C7E1FE954BC6AEBD8A0C5E338B638)
