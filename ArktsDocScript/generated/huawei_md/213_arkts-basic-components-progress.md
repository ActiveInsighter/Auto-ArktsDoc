...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ProgressOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressoptions对象说明) | 是 | 按进度条类型不同，设置不同属性的进度条组件参数。 |
...
| type8+ | [ProgressType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progresstype8枚举说明) | 否 | 是 | 指定进度条类型。 默认值：ProgressType.Linear **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。 **说明：** 不同的type需分别对应相应的[style](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#style8)属性设置，详细映射关系参考[ProgressStyleMap](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstylemap10对象说明)。 |
| style(deprecated) | [ProgressStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyle枚举说明) | 否 | 是 | 指定进度条样式。 该参数从API version8开始废弃，建议使用type替代。 默认值：ProgressStyle.Linear |
...
| 名称 | 类型 |
| --- | --- |
| ProgressType.Linear | [LinearStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#linearstyleoptions10) | [ProgressStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.Ring | [RingStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#ringstyleoptions10) | [ProgressStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.Eclipse | [EclipseStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#eclipsestyleoptions10) | [ProgressStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.ScaleRing | [ScaleRingStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#scaleringstyleoptions10) | [ProgressStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
| ProgressType.Capsule | [CapsuleStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#capsulestyleoptions10) | [ProgressStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ProgressStyleOptions8+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstyleoptions8) | [CapsuleStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#capsulestyleoptions10) | [RingStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#ringstyleoptions10) | [LinearStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#linearstyleoptions10) | [ScaleRingStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#scaleringstyleoptions10) | [EclipseStyleOptions10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#eclipsestyleoptions10) | 是 | 组件的样式。 - CapsuleStyleOptions：设置Capsule的样式。 - RingStyleOptions：设置Ring的样式。 - LinearStyleOptions：设置Linear的样式。 - ScaleRingStyleOptions：设置ScaleRing的样式。 - EclipseStyleOptions：设置Eclipse的样式。 - ProgressStyleOptions：仅可设置各类型进度条的strokeWidth、scaleCount、scaleWidth，仅对支持这些样式设置的进度条生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| isPrivacySensitiveMode | [Optional<boolean>](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt) | 是 | 设置隐私敏感，隐私模式下进度清零，文字将被遮罩。true：打开隐私敏感；false：关闭隐私敏感。 默认值：false **说明：** 设置null表示不敏感。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| enableScanEffect | boolean | 否 | 是 | 扫光效果的开关。仅支持[Linear、Ring、Capsule](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progresstype8枚举说明)类型的进度条。 true：表示开启扫光效果。 false：表示关闭扫光效果。 默认值：false |
...
| status | [ProgressStatus10+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#progressstatus10枚举说明) | 否 | 是 | 设置进度条状态。当设置为ProgressStatus.LOADING时会开启检查更新动效，此时设置进度值不生效。当从ProgressStatus.LOADING设置为ProgressStatus.PROGRESSING时，检查更新动效会执行到终点再停止。 默认值：ProgressStatus.PROGRESSING |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2b/v3/uVxBbGy_R6ucRZtL4j0PDQ/zh-cn_image_0000002541961160.png?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=F6031478E7F48DC9800F60BF830392B91815B9E126020401961D75E640522ED1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/svCTpNv_Sy-T-_IpUJSeaQ/zh-cn_image_0000002572641105.png?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=9F208D18CA940800405C39BAB8A564E602D9910E86AD1606E16786A602636BE1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5c/v3/CLhQBUAuQ3C0svSFIq2Kjg/zh-cn_image_0000002542120798.gif?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=88AB03D6EBD39E755D77D8B082B8E33D6686538B3B2650958E22F7B4A4B39490)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/62lyrUn9QIuqaRxzqtrUpw/zh-cn_image_0000002572681069.png?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=D4969B208353918464449675978D29A5930870ED60EF7C5A56A0C73F78902EE2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/29/v3/giRoeawOS1CobLBER5udJw/zh-cn_image_0000002541961162.gif?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=69F21781DA5649675E19B5CFC51D1E2E3BCEF9E391F08E160162A81A7EAE08DD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/AYQJxUdPTzKm_oVYrj8piw/zh-cn_image_0000002572641107.gif?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=A59242DE70E38C136F4D831F7C689A2A6766E826B98BE2DE8A04BF68D4253A84)

### 示例7（设置隐私隐藏）

该示例通过[privacySensitive](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#privacysensitive12)属性，实现了隐私隐藏效果。效果展示需要卡片框架支持。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/Zp9mCspTQVeQLhYGG_9cXQ/zh-cn_image_0000002542120800.gif?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=0C7104C355AA2035710D6458B811791F4E0CC4273AD9F03982D4964446CBC17A)

### 示例8（设置Capsule进度条圆角半径）

该示例通过[CapsuleStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-progress#capsulestyleoptions10)的入参borderRadius，实现了Capsule类型进度条圆角半径设置。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/y-Wb9ZUGRJOMXa07FEM9UQ/zh-cn_image_0000002572681071.png?HW-CC-KV=V1&HW-CC-Date=20260420T030142Z&HW-CC-Expire=86400&HW-CC-Sign=16279C5624EB0AD7E9917512320881F8A9C5A237FDD5BA247D72E7CD45760044)
