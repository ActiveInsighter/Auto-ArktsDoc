...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [HdsTabsOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section194091491257) | 否 | HdsTabs组件参数。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| controller | [HdsTabsController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section13103111423616) | 否 | 是 | HdsTabs控制器。 默认值：undefined。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [HdsBarMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section880135003119) | 是 | 所有TabBar都使用实际布局宽度，当设置为BarMode.Scrollable时，若实际布局宽度超过总宽度（横向Tabs的barWidth，纵向Tabs的barHeight），则具有滑动效果；当设置为HALF_SCREEN_FIXED时，所有页签总高度之和为HdsTabs组件高度的四分之一，且处在二分之一屏的居中位置。 > **说明** > 当设置为HALF_SCREEN_FIXED样式时： > > 1. 依赖页签位于侧边栏，vertical设置为true。 > 2. 依赖页签使用BottomTabBarStyle样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[HdsDividerStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section9535642152319)> | 是 | 分割线样式，默认跟手渐变。 mode：分割线模式，可以设置为常隐，常显和跟手渐变显隐（当内容区超过页签栏）。 style：分割线的样式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| backgroundStyle | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[HdsTabsBackgroundStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section86661977269)> | 是 | 设置模糊的颜色和高度，默认模糊效果失效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [BlurStrategy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1086755971212) | 是 | 设置页签栏的模糊生效策略。 默认值：BlurStrategy.ADAPTIVE。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| mode | [DividerMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section186781730153111) | 否 | 否 | 页签栏分割线显示类型。 默认值：DividerMode.FOLLOW_SCROLL。 |
...
切换动画开始时触发该回调。当[animationDuration](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section13511122142)为0时动画关闭，不触发该回调。
...
| 类型 | 说明 |
| --- | --- |
| [ExtendBarMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section15758214103115) | TabBar扩展的布局模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| builder | [CustomTabBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdstabs#section1434192490) | 是 | 设置自定义组件出血效果。 |
...
| 常显 | 常隐 | 跟手 |
| --- | --- | --- |
| ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/eDEPR8J4QBmb6-9-RWN7OA/zh-cn_image_0000002500304214.gif?HW-CC-KV=V1&HW-CC-Date=20260414T025441Z&HW-CC-Expire=86400&HW-CC-Sign=8DF46D9F86C918A54125B8E20E546C21CFAF346539A6A1C7A9B2A6E2B31B752D) | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/RhUuaRQLRkK633eVK59tyw/zh-cn_image_0000002532304091.gif?HW-CC-KV=V1&HW-CC-Date=20260414T025441Z&HW-CC-Expire=86400&HW-CC-Sign=29CFD9C47D2904F970AE925589924227A6800C8E403E7EC08D7C0CAAF5A1CFD7) | ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ae/v3/3R0AqmMHTH2oxlK_iPShug/zh-cn_image_0000002532144123.gif?HW-CC-KV=V1&HW-CC-Date=20260414T025441Z&HW-CC-Expire=86400&HW-CC-Sign=B7CA602CE3DE9D36B4BBEB9E713725B482873AC49CC930E1B5B1DC7A81F0E4DC) |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/98/v3/-0QsY2JJT3isjvstXsGArA/zh-cn_image_0000002532144137.png?HW-CC-KV=V1&HW-CC-Date=20260414T025441Z&HW-CC-Expire=86400&HW-CC-Sign=EB220A16F618D9124C6B898245BBA29B3041A0458162D873D9B761741339BBF3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/zBqK6vHGRrCCI5_YieLDTQ/zh-cn_image_0000002500424070.jpg?HW-CC-KV=V1&HW-CC-Date=20260414T025441Z&HW-CC-Expire=86400&HW-CC-Sign=8299211192F299EA70363FE953F4A587E3DDBDFF227C4811B7C3351A2343E2FD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/KBqtufeTSheg5ZvjKGgvAQ/zh-cn_image_0000002500304222.jpg?HW-CC-KV=V1&HW-CC-Date=20260414T025441Z&HW-CC-Expire=86400&HW-CC-Sign=00F05C12969895E2720A9AEA4A8185430801947C1455153AC458673624DFB1F6)
