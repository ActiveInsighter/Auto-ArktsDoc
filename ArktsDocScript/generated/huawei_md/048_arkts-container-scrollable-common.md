# 滚动组件通用接口-滚动与滑动-ArkTS组件-ArkUI（方舟UI框架）-应用框架 - 华为HarmonyOS开发者
...
设置滚动条的颜色。与[scrollBarColor11+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollbarcolor11)相比，color参数开始支持Resource类型。
...
| options | [EdgeEffectOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#edgeeffectoptions11对象说明) | 否 | 组件内容大小小于组件自身时是否开启滑动效果，以及设置边缘效果生效的边缘。设置为{ alwaysEnabled: true }会开启滑动效果，{ alwaysEnabled: false }不开启。 默认值： List、Grid、WaterFlow组件默认{ alwaysEnabled: false, EffectEdge: EffectEdge.START | EffectEdge.END }，Scroll组件默认{ alwaysEnabled: true, EffectEdge: EffectEdge.START | EffectEdge.END }。 |
...
| options | [FadingEdgeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#fadingedgeoptions14对象说明) | 否 | 边缘渐隐参数对象。可以通过该对象定义边缘渐隐效果属性，比如设置渐隐长度。 如果设置小于0的值或undefined或者不设置则取默认值，默认长度为32vp。 如果设置的长度超过容器高度的一半时，渐隐长度取容器高度的一半。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| clip | [ContentClipMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#contentclipmode14枚举说明) | [RectShape](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#rectshape) | 是 | 裁剪只针对滚动容器的内容，即其子节点，背景不受影响。通过RectShape传入自定义矩形区域时仅支持设置宽高和相对于组件左上角的[offset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-shape#offset)，不支持圆角。 默认值：Grid、Scroll的默认值为ContentClipMode.BOUNDARY，List、WaterFlow的默认值为ContentClipMode.CONTENT_ONLY。 |
...
支持当前页面的滚动组件收到点击状态栏事件后，通过动画回到顶部。点击状态栏后，后台应用的滚动组件不受影响，不做回到顶部的动作。本属性不受[enableScrollInteraction](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#enablescrollinteraction11)设置的影响。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [Optional](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-custom-property#optionalt)<[OnWillScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onwillscrollcallback12)> | 是 | 滚动组件滑动前触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onscrollcallback12) | 是 | 滚动组件滑动时触发的回调。 |
...
> **说明**
> 从API version 11开始支持，从API version 12开始废弃，[List](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list)、[Grid](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-grid)和[WaterFlow](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-waterflow)组件的onScroll事件在布局之后触发，建议使用[onDidScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#ondidscroll12)替代；[Scroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scroll)组件的onScroll事件在布局之前触发，建议使用[onWillScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onwillscroll12)替代。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnWillStopDraggingCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onwillstopdraggingcallback20) | 是 | 滚动组件划动离手时触发的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnDidStopDraggingCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#ondidstopdraggingcallback21) | 是 | 滚动组件结束拖动时触发的回调。 |
...
> - 惯性动效的触发场景参考[flingSpeedLimit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#flingspeedlimit11)方法的说明。
...
[nestedScroll](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#nestedscroll11)属性参数对象。
...
[edgeEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#edgeeffect11)属性参数对象。
...
| effectEdge18+ | number | 否 | 是 | 设置边缘效果生效的边缘。 如果设置[EffectEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).START表示只有起始边生效。如果设置[EffectEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).END表示只有末尾边生效。 默认值为[EffectEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).START | [EffectEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#effectedge18枚举说明).END表示双边同时生效。当设置为其它异常值时，则默认双边同时生效。 如果需要双边都不生效，可将edgeEffect设置为EdgeEffect.None。 **元服务API：** 从API version 18开始，该接口支持在元服务中使用。 |

## FadingEdgeOptions14+对象说明

[fadingEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#fadingedge14)属性边缘渐隐参数对象。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/76/v3/SNSksPSLRbeL6xOzpTN9mg/zh-cn_image_0000002532906954.png?HW-CC-KV=V1&HW-CC-Date=20260328T023118Z&HW-CC-Expire=86400&HW-CC-Sign=98ED0802A57B0C5728CACB8631530DA6CADEAFB9904420C170E794D808B9114D)
...
| 类型 | 说明 |
| --- | --- |
| void | [ScrollResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollresult12对象说明) | 返回ScrollResult时按照开发者指定的相对上一帧的偏移量滑动；不返回时按回调参数scrollOffset滑动。 取值范围：(-∞, +∞) |
...
[OnWillScrollCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#onwillscrollcallback12)返回值对象。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/e8cNbvTwS_OVnZshTNwHPQ/zh-cn_image_0000002563786797.gif?HW-CC-KV=V1&HW-CC-Date=20260328T023118Z&HW-CC-Expire=86400&HW-CC-Sign=94A93757614C83E826A903D10105D114681CBDEE1D9B1172BCD40E5D660333AB)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6f/v3/KPVZ3DTKQ7u7aZpab8ngZw/zh-cn_image_0000002533066852.gif?HW-CC-KV=V1&HW-CC-Date=20260328T023118Z&HW-CC-Expire=86400&HW-CC-Sign=D04AE7E85D86BEEB3C51B67F68B700B51D8BA3BF8A120782AA2BF46ECEBA3A82)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/6fee4w6QSr2huY95iocaJw/zh-cn_image_0000002533066902.gif?HW-CC-KV=V1&HW-CC-Date=20260328T023118Z&HW-CC-Expire=86400&HW-CC-Sign=DD2168F5E9EA78A0EDF35799359900A3A1ABBBAD482D5435F6710655B3ED65A1)

### 示例4（设置滚动条边距）

从API version 20开始，该示例通过设置[scrollBarMargin](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollbarmargin20)属性，调整滚动组件的滚动条边距。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ac/v3/urju59dzSuu70y-QcQP8Tw/zh-cn_image_0000002563866805.gif?HW-CC-KV=V1&HW-CC-Date=20260328T023118Z&HW-CC-Expire=86400&HW-CC-Sign=15409EDC0F9FDB6594E7F1C2EB3122E572497111D4D1F7684EA116FDFB1B3C0E)
