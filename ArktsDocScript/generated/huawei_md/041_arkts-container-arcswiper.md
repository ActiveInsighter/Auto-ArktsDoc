...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [ArcSwiperController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcswipercontroller) | 否 | 给组件绑定一个控制器，用来控制组件翻页。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| style | Optional<[ArcDotIndicator](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcdotindicator) | boolean> | 是 | 弧形圆点指示器样式。 - ArcDotIndicator：弧形圆点指示器属性及功能。 - boolean：是否启用弧形圆点指示器。设置为true启用，false不启用。 默认值：true 默认类型：ArcDotIndicator |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| sensitivity | Optional<[CrownSensitivity](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#crownsensitivity18)> | 是 | 旋转表冠的灵敏度。 默认值：CrownSensitivity.MEDIUM |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [FinishAnimationHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#finishanimationhandler) | 否 | 动画结束的回调。 默认值：不传入的情况，无回调 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| direction | Optional<[ArcDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#arcdirection-1)> | 是 | 设置弧形指示器的方向。 默认值：ArcDirection.SIX_CLOCK_DIRECTION，6点钟方向。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional<[AnimationStartHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#animationstarthandler)> | 是 | 切换动画开始时的回调。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | Optional<[GestureSwipeHandler](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#gestureswipehandler)> | 是 | 在页面跟手滑动过程中，逐帧触发该回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| timeout | number | 否 | 是 | ArcSwiper自定义切换动画超时时间。从页面执行默认动画（页面滑动）至移出视窗外的第一帧开始计时，如果到达该时间后，开发者仍未调用[SwiperContentTransitionProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#swipercontenttransitionproxy)的[finishTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#finishtransition)接口通知ArcSwiper组件此页面的自定义动画已结束，那么组件就会认为此页面的自定义动画已结束，立即在该页面节点下渲染树。单位ms，默认值为0。 |
| transition | Callback<[SwiperContentTransitionProxy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#swipercontenttransitionproxy)> | 否 | 否 | 自定义切换动画具体内容。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/25/v3/GIqPSmpfQfm8FP8w714Npg/zh-cn_image_0000002532906940.gif?HW-CC-KV=V1&HW-CC-Date=20260328T075022Z&HW-CC-Expire=86400&HW-CC-Sign=48B96CB26338B98DE10A136479981E76C78FFCA920841DB0105B7238F970137E)

### 示例2（设置ArcSwiper自定义页面切换动画）

该示例通过[customContentTransition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-arcswiper#customcontenttransition)接口，实现了自定义ArcSwiper页面切换动画。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/68/v3/XuR8FD8YRc2UcBVPTmpwng/zh-cn_image_0000002533066888.gif?HW-CC-KV=V1&HW-CC-Date=20260328T075022Z&HW-CC-Expire=86400&HW-CC-Sign=A1E888D998D943C56D02ECE684DE0896D1998438ABC0BE6F2788D529196C9EA1)
