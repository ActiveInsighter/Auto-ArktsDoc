...
> **说明**
> 过多的嵌套组件数会导致性能劣化。在部分场景中，直接使用组件属性或借助系统API的能力可以替代层叠容器的效果，减少了嵌套组件数进而优化性能。最佳实践请参考
> 组件嵌套优化-优先使用组件属性代替嵌套组件
> 。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [StackOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-stack#stackoptions18对象说明) | 否 | 设置子组件在容器内的对齐方式。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/9vumVWzLSNCgOJ_Ox3w3ng/zh-cn_image_0000002562145751.png?HW-CC-KV=V1&HW-CC-Date=20260320T122157Z&HW-CC-Expire=86400&HW-CC-Sign=74007FA2EBAF353D3637E9B9D70A2E37986EA772054B6DDC274A41DB70EE274B)
