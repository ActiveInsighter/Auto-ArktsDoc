...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| controller | [PatternLockController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#patternlockcontroller) | 否 | 设置PatternLock组件控制器，可用于控制组件状态重置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | Optional<[CircleStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#circlestyleoptions12对象说明)> | 是 | 宫格圆点在“激活”状态的背景圆环样式。 |
...
| radius | [LengthMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 背景圆环的半径。 默认值：[circleRadius](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#circleradius)的1.833倍（即11/6）。 **元服务API：** 从API version 12开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| result | [PatternLockChallengeResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#patternlockchallengeresult11枚举说明) | 是 | 图案密码状态。包括正确和错误状态。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0d/v3/83aA5d6KSq-nV5-pS2tvKw/zh-cn_image_0000002537174178.gif?HW-CC-KV=V1&HW-CC-Date=20260410T025548Z&HW-CC-Expire=86400&HW-CC-Sign=3EF1337EEA55AB6AB30D8F130C3FA6ABD251F1B7381158B69578C3B1E330720B)

### 示例2（判断密码是否正确）

该示例通过[sideLength](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#sidelength)属性设置九宫格的大小、[circleRadius](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#circleradius)属性设置宫格圆点样式、[onPatternComplete](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-patternlock#onpatterncomplete)属性设置密码输入时的回调。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fe/v3/D7nZUpXpTz2PX5JTLYZwJA/zh-cn_image_0000002537334098.gif?HW-CC-KV=V1&HW-CC-Date=20260410T025548Z&HW-CC-Expire=86400&HW-CC-Sign=B483ACD93CA2636728DAA37BEE204AB0EC99A37622A12792AD8A9D7F8BE0F8D2)
