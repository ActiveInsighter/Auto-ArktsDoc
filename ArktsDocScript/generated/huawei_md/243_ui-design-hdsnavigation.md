...
本模块提供导航组件的能力，默认支持标题栏随内容区滚动的动态模糊样式。6.0.0(20)版本以后，推荐使用[bindToScrollable](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section14512122441412)、[bindToNestedScrollable](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1375318442179)属性绑定导航组件和可滚动容器组件后，再使用导航组件滚动相关的功能，从而获得更优的体验。如滚动生效动态模糊样式，标题栏随内容区滚动动态显隐功能等。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [HdsNavigationTitleBarOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1867665412513) | 否 | 标题栏配置信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [HdsNavigationTitleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section26841314155317) | 是 | 页面标题栏显示模式。 默认值：HdsNavigationTitleMode.FREE。 |
...
设置是否隐藏标题栏中的返回键。返回键仅针对[titleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section0266105514213)为HdsNavigationTitleMode.MINI时才生效。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| builder | [NavDestinationBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section147171747131910) | 是 | 创建HdsNavDestination组件。 |
...
**规则：** 优先级规则详见[minContentWidth](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section03511461273)属性的说明。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [NavBarWidthRangeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section6345424102713) | 是 | 导航栏最小和最大宽度配置。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DynamicHideParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section453532817500) | 是 | 标题栏跟随内容区滚动动态显隐配置。 当标题栏模式为HdsNavigationTitleMode.MODAL时该接口设置无效。 不支持在显隐过程中动态切换属性。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| scrollers | Array<[NestedScrollInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section28581254125712)> | 是 | 嵌套的可滚动容器组件的控制器。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [Callback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#callback12)<[HdsNavigationTitleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section26841314155317)> | 是 | 参数为标题栏显示模式。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| delegate | [CustomTransitionDelegate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section357932612138) | 是 | 自定义转场动画回调方法。 |
...
| 名称 | 值 | 说明 |
| --- | --- | --- |
| FREE | 0 | 标题随着内容向上滚动而缩小（子标题的大小不变、淡出）。向下滚动内容到顶时则恢复原样。 未滚动状态，标题栏高度与FULL模式一致；滚动时，标题栏的最小高度与MINI模式一致。 推荐搭配[bindToScrollable](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section14512122441412)/[bindToNestedScrollable](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1375318442179)体验更佳的联动效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [HdsNavigationBadgeIconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section7349101217489) | 带信息提醒的图标配置信息。 |
...
| 类型 | 说明 |
| --- | --- |
| [HdsNavigationIconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section74312125454) | 图标配置信息。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundColor | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 标题栏背景板背景色。 默认值： - 当模糊样式类型配置为COMMON_BLUR时，默认值为透明色。 - 当模糊样式类型配置为GRADUAL_BLUR时，默认值为透明色。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为false时，模糊蒙层直接生效默认渐变颜色。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为true时，动态样式生效前，模糊蒙层生效为透明色，动态样式生效后，模糊蒙层生效默认渐变色。 模糊蒙层默认渐变色参数为：颜色和其对应的百分比位置的数组为：[["#99000000",0],["#8F000000",0.15],["#66000000",0.5],["#40000000",0.65],["#26000000",0.75],["#12000000",0.85], ["#00000000",1]]， 生效方向为[GradientDirection](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-appendix-enums#gradientdirection).Bottom。 |
...
| subTitleColor | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 标题栏副标题颜色。 默认值： - 当模糊样式类型配置为COMMON_BLUR时，副标题默认颜色为$r('sys.color.font_secondary')。 - 当模糊样式类型配置为GRADUAL_BLUR时，动态样式生效前，副标题默认颜色为$r('sys.color.font_on_secondary')，动态样式生效后，副标题默认颜色为$r('sys.color.font_secondary')。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为false时，副标题默认颜色为$r('sys.color.font_on_secondary')。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为true时，动态样式生效前，副标题默认颜色为$r('sys.color.font_secondary')，动态样式生效后，副标题默认颜色为$r('sys.color.font_on_secondary')。 |
...
| iconColor | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 标题栏图标色。在配置了图标模式为[IconStyleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section172403812484)时生效。 默认值： - 当模糊样式类型配置为COMMON_BLUR时，默认值为$r('sys.color.icon_primary')。 - 当模糊样式类型配置为GRADUAL_BLUR时，在动态样式生效前，默认值为$r('sys.color.icon_on_primary')；动态样式生效后，默认值为$r('sys.color.icon_primary')。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为false时，默认值为$r('sys.color.icon_on_primary')。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为true时，动态样式生效前，默认值为$r('sys.color.icon_primary')，动态样式生效后，默认值为$r('sys.color.icon_on_primary')。 |
| textColor | [ResourceColor](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resourcecolor) | 否 | 是 | 标题栏图标文本色。在配置了图标模式为[TextStyleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1563041134414)时生效。 默认值： - 当模糊样式类型配置为COMMON_BLUR时，默认值为$r('sys.color.font_primary')。 - 当模糊样式类型配置为GRADUAL_BLUR时，在动态样式生效前，默认值为$r('sys.color.font_on_primary')；动态样式生效后，默认值为$r('sys.color.font_primary')。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为false时，默认值为$r('sys.color.font_on_primary')。 - 当模糊样式类型配置为GRADIENT_BLUR且ScrollEffectOptions.enableScrollEffect配置为true时，动态样式生效前，默认值为$r('sys.color.font_primary')，动态样式生效后，默认值为$r('sys.color.font_on_primary')。 **起始版本：**6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| titleStyle | [HdsNavigationTitleStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section18445141914017) | 否 | 是 | 标题栏内容区标题样式。 |
| menuStyle | [HdsNavigationIconItemStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1132015774014) | 否 | 是 | 标题栏内容区菜单栏样式。 |
| backIconStyle | [HdsNavigationIconItemStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1132015774014) | 否 | 是 | 标题栏内容区返回图标样式。 |
| subIconStyle | [HdsNavigationIconItemStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1132015774014) | 否 | 是 | 标题栏内容区子图标样式。 **起始版本：**6.0.0(20) |
| dividerStyle | [HdsNavigationDividerStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1967916431016) | 否 | 是 | 标题栏内容区分割线样式。 **起始版本：**6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| backgroundStyle | [HdsNavigationBackgroundStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section6828845123712) | 否 | 是 | HdsNavigation标题栏背板样式。 |
| contentStyle | [HdsTitleBarContentStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section8553559194113) | 否 | 是 | HdsNavigation标题栏内容区样式。 |
...
| scrollEffectType | [ScrollEffectType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section21731754221) | 否 | 是 | 标题栏模糊样式类型。 默认值：ScrollEffectType.COMMON_BLUR。 |
| blurEffectiveStartOffset | [LengthMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 动态样式生效时，内容区滑动距离的下门限。内容区向上滑动超过该门限，开始生效动态样式。 默认值：LengthMetric.vp(0)。 标题栏不随内容区滚动而变小时，作为滚动距离计算的起点。 |
| blurEffectiveEndOffset | [LengthMetrics](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-graphics#lengthmetrics12) | 否 | 是 | 动态样式最终生效时，内容区滑动距离的上门限。内容区向上滑动超过该门限，生效最终的动态样式，下门限至上门限之间，动态样式参数随滑动距离线性变化生效。 默认值： - 标题栏模糊样式类型设置为ScrollEffectType.COMMON_BLUR或者ScrollEffectType.GRADIENT_BLUR时，默认值为LengthMetric.vp(8)。 - 标题栏模糊样式类型设置为ScrollEffectType.GRADUAL_BLUR，默认值为LengthMetric.vp(56)。 标题栏不随内容区滚动而变小时，作为滚动距离计算的起点。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| scrollEffectOpts | [ScrollEffectOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section646561734417) | 否 | 是 | 标题栏的动态样式参数配置。 |
| originalStyle | [HdsNavigationTitleBarStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section2462651174318) | 否 | 是 | 设置标题栏动态样式生效前的初始样式。 |
| scrollEffectStyle | [HdsNavigationTitleBarStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section2462651174318) | 否 | 是 | 设置标题栏动态样式生效后的最终样式。 如果设置的模糊参数与模糊样式类型不匹配时，按照模糊样式类型对应的默认样式生效。 |
| blurStrategy | [BlurStrategy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1086755971212) | 否 | 是 | 设置标题栏的模糊生效策略。 默认值：BlurStrategy.ADAPTIVE。 **起始版本：**6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [IconType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section2930111714251) | 否 | 是 | 图标型菜单项支持的图片资源类型。 不配置时，显示空白。 |
...
| type | [IconStyleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section172403812484) | [TextStyleMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1563041134414) | 否 | 是 | 标题栏图标类型。当图标类型配置为TextStyleMode.NORMAL时，该图标不支持设置badge属性。 默认值：IconStyleMode.NORMAL。 **起始版本：**6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| content | [HdsNavigationIconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section74312125454) | 否 | 是 | 图标配置信息。 |
| badge | [HdsNavigationBadgeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section9994192913455) | 否 | 是 | 信息标记配置。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| value | Array<[HdsNavigationMenuItemOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section16350125562818)> | 否 | 是 | 菜单栏的图标配置。 |
| maxCount | number | 否 | 是 | 菜单栏最多显示的图标个数，默认最多支持显示3个图标，多余的图标会被放入自动生成的更多图标。 |
| multiWindowEntryInAPPMenu | [MultiWindowEntryInAPPMenuParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section34012132713) | 否 | 是 | 应用内多窗菜单栏配置。 > **说明** > 依赖全景多窗特性，只有当前设备及屏幕状态支持全景多窗，才支持设置此功能。目前支持全景多窗的设备形态有： > > - 双折叠：展开态。 > - 三折叠：双屏态，三屏态的横屏态。 > - 平板：横屏态。 > > 对于不支持的设备形态，该组件不可交互，不响应点击事件。 **起始版本：**6.0.0(20) |
...
| subTitleBuilder | [CustomBuilder](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#custombuilder8) | 否 | 是 | 设置标题栏底部自定义区域。该配置只在标题栏模式为HdsNavigationTitleMode.MODAL或者HdsNavDestinationTitleMode.MODAL时生效。 **起始版本：**6.0.0(20) |
| subTitleComponent | [ComponentContent](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-arkui-componentcontent) | 否 | 是 | 设置标题栏底部自定义区域。该配置只在标题栏模式为HdsNavigationTitleMode.MODAL或者HdsNavDestinationTitleMode.MODAL时生效。 当同时配置了subTitleBuilder属性与subTitleComponent属性时，生效subTitleComponent属性。 **起始版本：**6.0.1(21) |
...
| showType | [BottomBuilderShowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1621712719586) | 否 | 是 | 设置标题栏底部自定义区域显示类型。只在HideMode配置为HideMode.SCROLL_UP_TO时，该配置生效。 默认值：BottomBuilderShowType.DIRECTLY_SHOW。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| showType | [DividerShowType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1759271114393) | 否 | 是 | 设置标题栏分割线显示类型。 默认值：DividerShowType.AUTO。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| title | [HdsNavigationTitle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section59501489496) | 否 | 是 | 设置标题栏标题内容。 |
| menu | [HdsNavigationMenuContentOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section158052224917) | 否 | 是 | 设置标题栏菜单栏内容。 |
| backIcon | [HdsNavigationBackButtonItemOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1931715301301) | 否 | 是 | 设置标题栏的返回按钮内容。 |
...
| bottomBuilder | [BottomBuilderParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section022717175435) | 否 | 是 | 设置标题栏底部自定义区域。 **起始版本：**6.0.0(20) |
| divider | [HdsNavigationDividerParams](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section102561040192912) | 否 | 是 | 设置标题栏分割线内容。 **起始版本：**6.0.0(20) |
| subIcon | [HdsNavigationBadgeIconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section7349101217489) | 否 | 是 | 设置标题栏子图标内容。 **起始版本：**6.0.0(20) |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| padding | [PaddingOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section14824153495010) | 否 | 是 | 标题栏内间距设置。 |
| style | [TitleBarStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section4190244154420) | 否 | 是 | 标题栏样式设置。 |
| content | [TitleBarContentOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section156391311175017) | 否 | 是 | 标题栏内容区设置。 |
...
| mode | [HideMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1576811571633) | 否 | 是 | 标题栏动态隐藏模式。 默认值：HideMode.SCROLL_UP_TO。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7f/v3/WwUKN1HkSvOlTbw210RSmg/zh-cn_image_0000002500304242.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=25DA4C49C0A422545F4BAE997AA27CF0A37D086B445E8AABB8406B65371B0990)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/TiOF2FuHSjmbMN97HD6jeA/zh-cn_image_0000002532144149.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=EF16F7081421E2CA78E5D83C9FAC38CCBAC6EB4D0040095967733DC6ADB479BF)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/rAc6W8VcTqevyj3giQja1Q/zh-cn_image_0000002500424092.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=CC61CFC0DA3F40F07B8EAF25A01269857D5537C3113429514523DF578C4FB46A)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/YM7M4UzfSBaxOcWFGKQszQ/zh-cn_image_0000002532304127.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=AB16D9FAB31C91B3DD563960B37354207CD45CFBF33622ADAB7324FAE55C3C5D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/cyTu-MMmR0yQbXj6uzbn-Q/zh-cn_image_0000002500304234.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=11DA04CE6925E68F6933F4C610122F08CEECD96EC99C560036DFF493CAFE991A)
      ...
      .titleBar({
        content: {
          title: {
            mainTitle: 'MainTitle',
            subTitle: 'SubTitle',
            subTitleBuilder: this.SubTitleBuilder.bind(this),
          },
          menu: {
            value: [{
              content: {
  ...
  build() {
    Column() {
      Button("transition modal")
        ...
        .fontSize(20)
        .margin(10)
        .bindSheet($$this.isShow, this.myBuilder(), {showClose: false})
    }
    .justifyContent(FlexAlign.Center)
    .width('100%')
    .height('100%')
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/aG6E0T84S1OT65WpFQcRYw/zh-cn_image_0000002500304230.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=D38894881AEDF1E12321380D04E3C66CCD155F587D44BCF1221B7431BD36A0B8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/hAMrJFW8TfqGrHqYTp8aqA/zh-cn_image_0000002532304119.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=28EDF8E4E2683E6D826D5C489BCB632FA983FC0ECAB4D0111DD50BE14ABE8BCD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/mB4Ce4bmSs-6PdV7cR295Q/zh-cn_image_0000002532144155.jpg?HW-CC-KV=V1&HW-CC-Date=20260418T024520Z&HW-CC-Expire=86400&HW-CC-Sign=14600095F65296D41AF0921A2930C168337ADE096B308252344BDA563160308B)
