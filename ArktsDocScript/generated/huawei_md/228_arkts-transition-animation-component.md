...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [TransitionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitionoptionsdeprecated)(deprecated) | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 是 | 设置组件插入显示和删除隐藏的过渡效果。 **说明：** 详细描述见[TransitionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitionoptionsdeprecated)和[TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)对象说明。 |
...
组件插入显示和删除隐藏的过渡效果。同[transition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transition)相比，增加了转场动画结束的回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| effect | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 是 | 设置组件插入显示和删除隐藏的过渡效果。 |
| onFinish | Optional<[TransitionFinishCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitionfinishcallback12)> | 是 | 转场动画结束回调。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| IDENTITY | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"identity"> | 是 | 否 | 禁用转场效果。 |
| OPACITY | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"opacity"> | 是 | 否 | 为组件添加透明度转场效果，出现时透明度从0到1、消失时透明度从1到0，相当于TransitionEffect.opacity(0)。 |
| SLIDE | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"asymmetric", { appear: [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"move", [TransitionEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitionedge10)>; disappear: [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"move", [TransitionEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitionedge10)>; }> | 是 | 否 | 相当于TransitionEffect.asymmetric(TransitionEffect.move(TransitionEdge.START), TransitionEffect.move(TransitionEdge.END))。从START边滑入，END边滑出。即在LTR模式下，从左侧滑入，右侧滑出；在RTL模式下，从右侧滑入，左侧滑出。 |
| SLIDE_SWITCH | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"slideSwitch"> | 是 | 否 | 指定出现时从右侧先缩小再放大滑入、消失时从左侧先缩小再放大滑出的转场效果。自带动画参数，也可覆盖动画参数，自带的动画参数时长600ms，指定动画曲线cubicBezierCurve(0.24, 0.0, 0.50, 1.0)，最小缩放比例为0.8。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"translate"> | 当前动画平移效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"rotate"> | 当前动画旋转效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"scale"> | 当前动画缩放效果。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"opacity"> | 当前动画透明度效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| edge | [TransitionEdge](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitionedge10) | 是 | 组件转场时从屏幕边缘滑入和滑出的效果，本质为平移效果，为插入时起点和删除时终点的值。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"move"> | 当前动画从屏幕边缘滑入和滑出的效果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| appear | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 是 | 指定出现的转场效果。 如不通过asymmetric函数构造TransitionEffect，则表明该效果在组件出现和消失时均生效。 |
| disappear | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 是 | 指定消失的转场效果。 如不通过asymmetric函数构造TransitionEffect，则表明该效果在组件出现和消失时均生效。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)<"asymmetric"> | 当前动画非对称的转场效果。 |
...
| effect | [Effect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 是 | 转场参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| transitionEffect | [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 是 | 被组合的过渡效果。 |

**返回值：**

| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 组合过渡效应。 |
...
| 类型 | 说明 |
| --- | --- |
| [TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明) | 当前动画效果。 |
...
> **说明**
> 从API version 7开始支持，从API version 10开始废弃，建议使用[TransitionEffect](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-transition-animation-component#transitioneffect10对象说明)替代。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c5/v3/5ila1MZITtOs0KmKP7uYNw/zh-cn_image_0000002535300716.gif?HW-CC-KV=V1&HW-CC-Date=20260403T024305Z&HW-CC-Expire=86400&HW-CC-Sign=941DFFE3AD8877F1B55ECBDF987A79A9037FD43E5C4B2429755154DE0A7EEEA5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/CCJ9o3iISDG21hpJMWFDFw/zh-cn_image_0000002566020579.gif?HW-CC-KV=V1&HW-CC-Date=20260403T024305Z&HW-CC-Expire=86400&HW-CC-Sign=4A602756A27B59510DDF01E3D4444A27003132839A12C9571E51DD4E8497DF14)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/QGtrzZwZSQap4XhjHT_9gQ/zh-cn_image_0000002566100591.gif?HW-CC-KV=V1&HW-CC-Date=20260403T024305Z&HW-CC-Expire=86400&HW-CC-Sign=198F317CDFB68911744E5F25E2EB4239B33E3006AF5BC492F6474CD70496CA1C)
