...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| icon | [SnackBarIconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssnackbar#section1980950306) | 是 | HdsSnackBar图标区的配置信息。 |
| message | [SnackBarMessageOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssnackbar#section193581154513) | 是 | HdsSnackBar中间内容区文本的配置信息。 |
| operation | [SnackBarOperationOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssnackbar#section20215133710214) | 是 | HdsSnackBar操作区的配置信息。 |
| style | [SnackBarStyleOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssnackbar#section460519981419) | 否 | HdsSnackBar样式的配置信息。 |
...
| iconType | [SnackBarIconType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssnackbar#section997613107164) | 否 | 是 | HdsSnackBar的图标类型。 默认值：SnackBarIconType.SMALL。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| operationType | [SnackBarOperationType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdssnackbar#section1436118313346) | 否 | 是 | HdsSnackBar的右侧操作区域元素样式。 |
...
| blurStrategy | [BlurStrategy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdsnavigation#section1086755971212) | 否 | 是 | HdsSnackBar的模糊生效策略。 默认值：BlurStrategy.ADAPTIVE。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bd/v3/R74tGLWlSPudsBXJP7oWEg/zh-cn_image_0000002532304107.gif?HW-CC-KV=V1&HW-CC-Date=20260413T030117Z&HW-CC-Expire=86400&HW-CC-Sign=FEFA13A8CFA4B01BB7876A0AC9E9005E0B69604D0B1F73C28D19C438930EB190)
