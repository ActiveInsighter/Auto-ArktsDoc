...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [SaveButtonOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-security-components-savebutton#savebuttonoptions) | 是 | 创建包含指定元素的保存控件。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [SaveIconStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-security-components-savebutton#saveiconstyle枚举说明) | 否 | 是 | 设置保存控件的图标风格。 不传入该参数表示没有图标。 |
| text | [SaveDescription](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-security-components-savebutton#savedescription枚举说明) | 否 | 是 | 设置保存控件的文本描述。 不传入该参数表示没有文字描述。 |
...
| result | [SaveButtonOnClickResult](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-security-components-savebutton#savebuttononclickresult枚举说明) | 是 | 授权的结果。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| text | string | [Resource](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#resource) | 是 | 自定义文本信息。 如果应用无ohos.permission.CUSTOMIZE_SAVE_BUTTON权限，则自定义文本设置不生效，保存控件保持默认样式。详见[SaveButtonOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-security-components-savebutton#savebuttonoptions)说明。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/59/v3/Po9L9Lu7TmOcEPUtthcJWw/zh-cn_image_0000002535949762.png?HW-CC-KV=V1&HW-CC-Date=20260407T024558Z&HW-CC-Expire=86400&HW-CC-Sign=7FCFA8A4269E2D45E03F26A333FDD4C79B74D15106DABB52D8C1413E03CBD1B7)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/Y5ZSsvR3QKOMnYz8xqgx-A/zh-cn_image_0000002566869595.png?HW-CC-KV=V1&HW-CC-Date=20260407T024558Z&HW-CC-Expire=86400&HW-CC-Sign=20DC8B21A529D776E3015AD5DBAB2930A056FB853FCFB54E2FF46A9DA4DE5413)
