...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [MarqueeOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#marqueeoptions18对象说明)18+ | 是 | 配置跑马灯组件的参数。 |
...
| step8+ | number | 否 | 是 | 滚动动画文本滚动步长。当step大于Marquee的文本宽度时，取默认值。 默认值：6 单位：[vp](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-pixel-units) **卡片能力：** 从API version 9开始，该接口支持在ArkTS卡片中使用。 **元服务API：** 从API version 11开始，该接口支持在元服务中使用。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | boolean | 是 | 是否允许文本缩放。 true：允许文本缩放；false：不允许文本缩放。 默认值：false **说明：** 仅当[fontSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-basic-components-marquee#fontsize)为fp单位时生效。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e5/v3/_GTlvfQlTrqEP-A1FEJpaw/zh-cn_image_0000002534411582.gif?HW-CC-KV=V1&HW-CC-Date=20260330T095502Z&HW-CC-Expire=86400&HW-CC-Sign=CCC4F1472A809F2BBF0D74CE4D0DFD1725CDE138B992D7953EA92781FA3913EA)
