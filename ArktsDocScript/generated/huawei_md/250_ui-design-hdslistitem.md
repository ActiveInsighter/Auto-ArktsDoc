...
| hdsListItemCard | [HdsListItemCardOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitemcard#section6323195713321) | 否 | - | 列表卡片项内容。 |
| swipeActionOptions | [HdsSwipeActionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section10384044394) | [SwipeActionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeactionoptions9对象说明) | 否 | - | 动效横滑内容展示。 HdsSwipeActionOptions是HdsListItem封装后的横滑动效类型，SwipeActionOptions支持用户自定义使用ListItem的横滑动效类型。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icons | Array<[SwipeIconConfigurations](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section113942388296)> | 否 | 是 | 配置除删除按钮之外其他三个按钮样式。 |
| deleteIconOptions | [DeleteIconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section17257185014306) | 否 | 是 | 配置删除按钮样式。 |
| fullDeleteOptions | [FullDeleteOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section184131316173219) | 否 | 是 | 配置滑动距离超过划出组件大小后的行为。 |
...
| 名称 | 类型 | 只读 | 可选 | 说明 |
| --- | --- | --- | --- | --- |
| icon | [SwipeIconType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section2930111714251) | 否 | 否 | 图标资源，可支持symbol或image类型。 |
| iconOptions | [IconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section1486115401) | 否 | 是 | 图标的能力选项。 |
...
| onAction | [SwipeActionCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section812564671318) | 否 | 是 | 点击回调。 |
...
| iconOptions | [IconOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section1486115401) | 否 | 是 | 删除按钮图标的能力选项。 |
| onAction | [SwipeActionCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section812564671318) | 否 | 是 | 点击回调。 |
...
| onFullDeleteAction | [SwipeActionCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitem#section812564671318) | 否 | 是 | 列表项删除的回调。 |
...
| [ImageOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ui-design-hdslistitemcard#section3582112115362) | image资源类型。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/aa/v3/YK5qblnHTqu6gixnxEGepg/zh-cn_image_0000002532304111.gif?HW-CC-KV=V1&HW-CC-Date=20260418T024529Z&HW-CC-Expire=86400&HW-CC-Sign=CA7E6C2C94138D06B2737CCFC679ADBAB6B99938215A63ABE2E5206E83085760)
