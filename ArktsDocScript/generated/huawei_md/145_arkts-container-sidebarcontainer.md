...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| type | [SideBarContainerType](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-sidebarcontainer#sidebarcontainertype枚举说明) | 否 | 设置侧边栏的显示类型。 默认值：SideBarContainerType.Embed |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [Length](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#length) | 是 | 侧边栏的宽度。 默认值：240vp 单位：vp 取值范围：[0, +∞) **说明：** API version 9的默认值为200vp，API version 10的默认值为240vp。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [DividerStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-sidebarcontainer#dividerstyle10对象说明) | null | 是 | 分割线的样式。 默认为DividerStyle：显示分割线。 - null或undefined：行为不做处理，分割线样式与默认值保持一致。 **说明：** API version 11及以下版本，null效果为不显示分割线。 |
...
- 如果[autoHide](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-sidebarcontainer#autohide9)属性为false，则会保持侧边栏宽度[minSideBarWidth](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-sidebarcontainer#minsidebarwidth)和内容区宽度minContentWidth不变，但内容区会被截断显示；
...
| icons | [ButtonIconOptions18+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-sidebarcontainer#buttoniconoptions18对象说明) | 否 | 是 | 设置侧边栏控制按钮的图标。 资源获取错误以及未设置该属性时，使用默认图标。 |
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cd/v3/tCD0nmlfTn2I417pXO-voA/zh-cn_image_0000002535949312.png?HW-CC-KV=V1&HW-CC-Date=20260405T024910Z&HW-CC-Expire=86400&HW-CC-Sign=13D1DDCD8DD36F70F4DBEA5BAE1958D7523DF4F0374747A3CB2550AC42DA4FCB)
