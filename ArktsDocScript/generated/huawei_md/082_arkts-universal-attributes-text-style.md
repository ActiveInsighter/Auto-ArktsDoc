...
| 类型 | 说明 |
| --- | --- |
| [CaretOffset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-text-style#caretoffset11对象说明) | 光标相对输入框的位置。 当controller未绑定组件或绑定controller的组件被释放时，返回undefined。 |
...
| textOperationOptions | [TextContentControllerOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-text-style#textcontentcontrolleroptions15) | 否 | 插入文本的配置选项，不设置时默认插入文本至末尾。 |
...
| 类型 | 说明 |
| --- | --- |
| [SymbolGlyphModifier](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/universal-attributes-attribute-symbolglyphmodifier#symbolglyphmodifier) | 返回当前的SymbolGlyphModifier。 |
