# List-滚动与滑动-ArkTS组件-ArkUI（方舟UI框架）-应用框架 - 华为HarmonyOS开发者
...
List的预加载是指除了加载显示区域可见区域外子组件外，还支持空闲时隙提前加载部分显示区域外不可见的子组件。使用预加载可以减少滚动丢帧，提升流畅性。预加载需要结合懒加载才会生效。List支持通过[cachedCount](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#cachedcount)设置预加载的数量。默认会预加载显示区域上下各一屏子节点（最大预加载16行子节点）。List和[ForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-foreach)、[LazyForEach](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-rendering-control-lazyforeach)、[Repeat](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-new-rendering-control-repeat)结合，预加载能力存在差异：
...
List(options?: [ListOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#listoptions18对象说明))
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [ListOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#listoptions18对象说明) | 否 | 设置List组件参数。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| count | number | [CacheCountInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#cachecountinfo22对象说明) | 是 | 当参数类型为number时，表示预加载的ListItem的数量。 取值范围：[0, +∞) 当参数类型为CacheCountInfo时，表示预加载的最大最小范围。 |
...
| gutter10+ | [Dimension](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-types#dimension10) | 否 | 列间距或行间距。 默认值：0 取值范围：[0, +∞) **说明：** gutter为列间距或行间距，当列数或行数大于1时生效。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ListItemAlign](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#listitemalign9枚举说明) | 是 | 交叉轴方向的布局方式。 默认值：ListItemAlign.Start |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [StickyStyle](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#stickystyle9枚举说明) | 是 | ListItemGroup吸顶或吸底效果。 默认值：StickyStyle.None |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| value | [ScrollSnapAlign](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#scrollsnapalign10枚举说明) | 是 | 列表项滚动结束对齐效果。 默认值：ScrollSnapAlign.NONE |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| speed | [ScrollSnapAnimationSpeed](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#scrollsnapanimationspeed22枚举说明) | 是 | 列表滚动限位动画速度。 默认值：ScrollSnapAnimationSpeed.NORMAL |
...
设置内容区域起始偏移量。列表滚动到起始位置时，列表内容与列表显示区域边界保留指定距离。与[contentStartOffset11+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#contentstartoffset11)相比，参数名改为offset，并开始支持Resource类型。
...
设置内容区末尾偏移量。列表滚动到末尾位置时，列表内容与列表显示区域边界保留指定距离。与[contentEndOffset11+](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#contentendoffset11)相比，参数名改为offset，并开始支持Resource类型。
...
> - stackFromEnd属性设置为true后，[ListOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#listoptions18对象说明)中initialIndex参数默认值为总item个数-1。
...
设置当前List组件是否处于可编辑模式。可参考[示例3](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#示例3设置编辑模式)实现删除选中的list项。
...
不支持拖动到List边缘时触发List的自动滚动，可以使用ForEach、LazyForEach、Repeat的[onMove](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-drag-sorting#onmove)接口实现该效果，参考[示例12（使用OnMove进行拖拽）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#示例12使用onmove进行拖拽)。但需注意[onMove](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-universal-attributes-drag-sorting#onmove)接口不支持跨ListItemGroup拖拽。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| handler | [OnScrollVisibleContentChangeCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#onscrollvisiblecontentchangecallback12) | 是 | 当前显示内容发生改变的时候触发回调。 |
...
| 类型 | 说明 |
| --- | --- |
| [VisibleListContentInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#visiblelistcontentinfo12对象说明) | 入参坐标处的子组件的索引信息。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| options | [CloseSwipeActionOptions](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#closeswipeactionoptions11对象说明) | 否 | 收起[EXPANDED](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem#swipeactionstate11枚举说明)状态的[ListItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem)的回调事件集合。 |
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| start | [VisibleListContentInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#visiblelistcontentinfo12对象说明) | 是 | 1. 通过该参数获取List显示区域第一个子组件在List中的索引值。 2. 如果当前List显示区域第一个子组件是ListItemGroup，可以获取当前List显示区域第一个组件属于该ListItemGroup的哪一区域。 3. 如果当前List显示区域第一个组件是ListItemGroup内的ListItem，可以获取该ListItem在ListItemGroup内的索引值。 |
| end | [VisibleListContentInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#visiblelistcontentinfo12对象说明) | 是 | 1. 通过该参数获取List显示区域最后一个子组件在List中的索引值。 2. 如果当前List显示区域最后一个子组件是ListItemGroup，可以获取当前List显示区域最后一个组件属于该ListItemGroup的哪一区域。 3. 如果当前List显示区域最后一个组件是ListItemGroup内的ListItem，可以获取该ListItem在ListItemGroup内的索引值。 |
...
| itemGroupArea | [ListItemGroupArea](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#listitemgrouparea12枚举说明) | 否 | 是 | 表示处于ListItemGroup的哪一个区域。 |
...
设置[onScrollIndex](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#onscrollindex)事件的回调。
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| callback | [OnListScrollIndexCallback](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#onlistscrollindexcallback19) | undefined | 是 | onScrollIndex事件的回调函数。 |
...
设置[onScrollVisibleContentChange](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#onscrollvisiblecontentchange12)事件的回调。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/aDs_KFFkQs6S7HCOatbKOg/zh-cn_image_0000002531795584.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=FD880D9C0997C04BF9C16C5FCF84F21CE9321F5B52F219E514E411B1310B9194)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/93/v3/3qXCm74XRhWgKLk9qkPaKg/zh-cn_image_0000002562555549.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=F3540AB782F5DB1C361504EB27A8036FE161CB476A4F694D5EB6F2728ADC59E2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/77/v3/Zraw1pUsRhKxpdXII8OVIw/zh-cn_image_0000002562715521.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=602320591B6E016F71D0D1CCD0B05C4380926151B4A2E9A0A309EAE93E1E7D2D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/34/v3/ucMGasyUQBO95h6Wn7cu3g/zh-cn_image_0000002531635650.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=4CC9499E2630496EE2945081F09B5C3B7BDCDCF06C228B9C21207EE3A2224F6E)

### 示例5（跳转准确）

该示例通过设置[childrenMainSize](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#childrenmainsize12)属性，实现了List在子组件高度不一致时调用scrollTo接口也可以跳转准确。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/15/v3/KLoXSM-iQM6hVdpPAab9eg/zh-cn_image_0000002531795586.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=D38D9A1977607201073A77960A5846CBD6146DFFB9D4D8F033742A3FA12E8785)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/02/v3/n1aVHXsCRU67qlDu8ARtHw/zh-cn_image_0000002562555551.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=56345A7A85FAFA0F0491E044DFAAB5E38960D72AA3334020D91F59D9671BD0E3)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f9/v3/hgvuQyc0Tl6CUHsUIyIO1g/zh-cn_image_0000002562715523.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=0A9BC4539C980EB0EAC424AAEA169819EABB716933DB599F45F06D5940DFFF47)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/01/v3/hRbjxweNR4ay0wBf0ccvUQ/zh-cn_image_0000002531635652.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=03FB8A3866D0F6D9A5D2F9C1454A2E259221C5ACF0D6903DE5204058F574C80A)

### 示例9（设置折行走焦）

从API version 20开始，该示例通过[focusWrapMode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#focuswrapmode20)接口，实现了List组件方向键走焦换行效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4e/v3/uStykxtASKe1lRSqxxYMlA/zh-cn_image_0000002531795588.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=5B9544B56AF875C40472177396A388E59868C6F42DCF5E1515940FA3E522F4A1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d6/v3/0K1QMMPuTGGNGr7mhGbhqg/zh-cn_image_0000002562555553.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=7A2C48C03C8826745D89B5A6423EABFC76377D07C6280C5B10342E5375B2061E)

### 示例11（设置滚动条的边距）

从API version 20开始，该示例展示了通过[scrollBarMargin](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-scrollable-common#scrollbarmargin20)属性设置滚动条边距并避让[contentStartOffset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#contentstartoffset11)、[contentEndOffset](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#contentendoffset11)区域的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/OToKO9ufQ1mtt3e_cENBDg/zh-cn_image_0000002562715525.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=07536AC8114D994B30F86C9432C339EC2364014F221DFE6D662FC4AA19B4D5B1)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/I7rfT8PFSM6ixFEpdUEf7w/zh-cn_image_0000002531635654.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=4B2B4FF8C72F68E3B24A6E6BBE5025636E08E17C568A92B2C2EF53CB2FF0DCE2)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/96/v3/PebxNwD7SjiCD1lqKoRE2g/zh-cn_image_0000002531795590.png?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=BFBFC29432454EB2784996EBD04348657E4256134DEC2FE9D98CC4854538F932)

List宽度属于md断点区间时显示3列。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/5-JmBJjJTiWUNA7IRrk_RQ/zh-cn_image_0000002562555555.png?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=27E559DDE7BDFEF313A4FCD31926847649BC535E7CEBDC8672F7EF3DB6C07C01)

List宽度属于lg及更大的断点区间时显示5列。

![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ba/v3/6comGgDlTzKvdY6guPSFuw/zh-cn_image_0000002562715527.png?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=01313B8FB3A7CBA979C5D2F01AF66AA6AE761285C7604E173C3AB7330A977D75)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/qdJ-0bZEQreeNeWnH8rVDQ/zh-cn_image_0000002531635656.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=8749F45946B1D4E62A1B415611FFDB62E6DF82B50E2BB90C874BB5A9A46F99CA)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/ZYayRZ8ASGqVejefS1725g/zh-cn_image_0000002531795592.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=163DA47D2A413B5BB58BCAC3E3985E3F87D4B2E767C699AFDE074ED359843016)

### 示例16（实现ListItemGroup中点击项的居中效果）

该示例使用[scrollToItemInGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-list#scrolltoitemingroup11)接口，实现了点击[ListItemGroup](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitemgroup)中的[ListItem](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ts-container-listitem)时将其居中的效果。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c0/v3/H9DVrdbrQA6E09NSqaj0iA/zh-cn_image_0000002562555557.gif?HW-CC-KV=V1&HW-CC-Date=20260324T022714Z&HW-CC-Expire=86400&HW-CC-Sign=9A0AE903852154A7C2DD8C56CE6E2F5967DEF64816C0D87234156D16402A2471)
